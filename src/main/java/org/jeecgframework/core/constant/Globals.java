...
public final class Globals {
	 ...
	 * 综合查询日志类型
	 */
	public static final Short Log_Type_ADD=1; //录入
	public static final Short Log_Type_REPORT=2;  //上报
	public static final Short Log_Type_RECTIFY=3; //整改
	public static final Short Log_Type_RETURN=4; //退回
	public static final Short Log_Type_REVIEW=5; //复查
	public static final Short Log_Type_OVERDUE=6; //超期升级
	public static final Short Log_Type_SUPERVISE=7; //督办
