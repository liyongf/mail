...
public class ResourceUtil {
	 ...
	 * 部门、用户、字典缓存
	 */
	public static  Map<String,String> userMapCache = new HashMap<>();
	public static  Map<String,List<Map<String,Object>>> dicMapCache = new HashMap<>();
	public static  Map<String,String> departMapCache = new HashMap<>();

	/**
	 * 缓存部门【缓存】
	 */
	public static List<Map<String, Object>> allDepart = new ArrayList<>();
	/**
	 * 缓存用户【缓存】
	 */
	public static List<Map<String, Object>> allUser = new ArrayList<>();
...
//	}
	...
	public static void setServerCert(String serverCert) {
		ResourceUtil.serverCert = serverCert;
	}
}
