 ...
 */
@Entity
@Table(name = "t_b_risk_manage_task_all", schema = "")
@SuppressWarnings("serial")
public class RiskManageTaskAllEntity implements java.io.Serializable {
	/**唯一编号*/
	private String id;
	...
	private RiskManageTaskAllManageEntity taskAllManage;
	...
	@JoinColumn(name = "task_all_manage_id")
	@NotFound(action= NotFoundAction.IGNORE)
	public RiskManageTaskAllManageEntity getTaskAllManage() {
		return taskAllManage;
	}

	public void setTaskAllManage(RiskManageTaskAllManageEntity taskAllManage) {
		this.taskAllManage = taskAllManage;
	}
	@Transient
	...
	@Transient
	public String getCreateNameTemp() {
		return createNameTemp;
	}

	public void setCreateNameTemp(String createNameTemp) {
		this.createNameTemp = createNameTemp;
	}
