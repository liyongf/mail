...
/**   
 * 之前只有专业管控要做 ， 动态管控现在是直接复制 major不仅是专业
 */
@Entity
@Table(name = "t_b_risk_manage_major", schema = "")
@SuppressWarnings("serial")
public class RiskManageMajorEntity implements java.io.Serializable {
	/**唯一编号*/
	private String id;
	...
	@Column(name="manageType",nullable=true)
