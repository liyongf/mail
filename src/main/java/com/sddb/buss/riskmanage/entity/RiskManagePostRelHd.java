 ...
 */
@Entity
@Table(name = "t_b_risk_manage_post_rel_hd", schema = "")
@SuppressWarnings("serial")
public class RiskManagePostRelHd implements java.io.Serializable {
	/**唯一编号*/
	private String id;

	/**风险管控时新录入的隐患*/
	private TBHiddenDangerExamEntity hd;
	...
	public TBHiddenDangerExamEntity getHd(){return this.hd;}
	public void setHd(TBHiddenDangerExamEntity hd){this.hd = hd;}
