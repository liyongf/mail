...
/**   
 * @Title: Entity
 * @Description: 用户-子窗口关联
 * @author zhangdaihao
 * @date 2018-03-19 10:14:56
 * @version V1.0   
 *
 */
@Entity
@Table(name = "t_s_user_child_window", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class TSUserChildWindowEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**子窗口ID*/
	...
	public TSUserChildWindowEntity(){}

	public TSUserChildWindowEntity(String userId,String position,String childWindowId){
		this.userId = userId;
