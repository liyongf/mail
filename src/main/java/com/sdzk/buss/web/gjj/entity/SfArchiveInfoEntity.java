 ...
 * @author gzy
 * @date 2023-10-30 17:03:32
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sf_archive_info", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SfArchiveInfoEntity implements java.io.Serializable {
	/**重大隐患档案编码*/
	private Integer id;
	/**矿端数据操作标识*/
	 ...
	 *@return: java.lang.Integer  重大隐患档案编码
	 */
	 ...
	 *@param: java.lang.Integer  重大隐患档案编码
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  隐患编码
	 */
	@Column(name ="HD_CODE",nullable=true,length=50)
