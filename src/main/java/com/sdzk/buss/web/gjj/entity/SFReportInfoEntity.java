 ...
 * @Description: 报告文件
 * @author zhanglong
 * @date 2023-10-27 13:39:21
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sf_report_info", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SFReportInfoEntity implements java.io.Serializable {
	/**报告文件编码*/
	private Integer id;
	/**矿端数据操作标识*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  报告类型
	 */
	@Column(name ="REPORT_TYPE",nullable=true,length=1)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  报告文件行成日期
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  报告文件行成日期
	 */
	 ...
	 */
	@Column(name ="REPORT_NAME",nullable=true,length=32)
