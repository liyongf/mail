...
<div region="center" style="padding:0px;border:0px">
	...
	<t:dgToolBar title="common.add" icon="icon-add" url="timeTaskController.do?addorupdate" funname="add" operationCode="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit" icon="icon-edit" url="timeTaskController.do?addorupdate" funname="update" operationCode="update"></t:dgToolBar>
	<t:dgToolBar title="common.view" icon="icon-search" url="timeTaskController.do?addorupdate" funname="detail" operationCode="detail"></t:dgToolBar>
</t:datagrid></div>
</div>
