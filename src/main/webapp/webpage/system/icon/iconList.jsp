...
<div region="center" style="padding:0px;border:0px">
    <t:datagrid name="iconList" title="icon.list" actionUrl="iconController.do?datagrid" fit="true" fitColumns="true" idField="id">
        ...
        <t:dgToolBar title="common.add.param" langArg="common.icon" icon="icon-add" url="iconController.do?addorupdate" funname="add" operationCode="add"></t:dgToolBar>
        <t:dgToolBar title="common.edit.param" langArg="common.icon" icon="icon-edit" url="iconController.do?addorupdate" funname="update" operationCode="update"></t:dgToolBar>
        <t:dgToolBar title="batch.generate.style" icon="icon-edit" url="iconController.do?repair" funname="doSubmit" operationCode="batchStyle"></t:dgToolBar>
        <t:dgToolBar title="UI标签链接按钮样式" icon="icon-add" url="webpage/common/functionIconStyleList.jsp?style=urlfont" funname="add" operationCode="iconStyle" ></t:dgToolBar>
    </t:datagrid>
</div>
</div>
