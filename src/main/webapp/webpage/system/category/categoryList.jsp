	...
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="categoryList" title="menu.sort.management"
			...
			<t:dgToolBar icon="icon-add" title="common.add"
				url="categoryController.do?addorupdate" funname="addCategory" operationCode="add"></t:dgToolBar>
			<t:dgToolBar icon="icon-edit" title="common.edit"
				url="categoryController.do?addorupdate" funname="updateCategory" operationCode="update" ></t:dgToolBar>
		</t:datagrid>
	</div>
</div>
