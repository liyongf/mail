...
<t:datagrid name="operationList" title="operate.manage" actionUrl="functionController.do?opdategrid&functionId=${functionId}" idField="id" checkbox="true">
...
<%--     <t:dgCol title="permission.name" field="TSFunction_functionName"></t:dgCol> --%>
    ...
    <t:dgToolBar title="批量删除"  icon="icon-remove" url="functionController.do?logicDoBatchDel" funname="deleteALLSelect" operationCode="batchdelete" ></t:dgToolBar>
	<t:dgFunOpt funname="editoperation(id,operationname)" title="common.edit" urlclass="ace_button"  urlfont="fa-edit"></t:dgFunOpt>
	<t:dgToolBar title="common.add.param" langArg="common.operation" icon="icon-add" url="functionController.do?addorupdateop&functionId=${functionId}" funname="add" operationCode="add"></t:dgToolBar>
</t:datagrid>
