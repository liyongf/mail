...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="noticeController.do?godetail" tiptype="1" beforeSubmit="setContent()">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
							...
							<label style="width: 95%">${tSNoticePage.noticeTitle}</label>
