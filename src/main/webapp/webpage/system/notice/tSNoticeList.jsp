...
<div id="main_depart_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSNoticeList" checkbox="true" fitColumns="true" title="common.notice" actionUrl="noticeController.do?datagrid2" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="通知标题"  field="noticeTitle"  hidden="false"  queryMode="group"  width="320"></t:dgCol>
      <t:dgCol title="内容"  field="noticeContent" formatterjs="title" hidden="false"  queryMode="group"  width="500"></t:dgCol>
   ...
   <t:dgToolBar title="common.add" icon="icon-add" url="noticeController.do?goAdd" funname="add" width="800" height="600" operationCode="add"></t:dgToolBar>
      <t:dgToolBar title="查看" icon="icon-search" url="noticeController.do?godetail" funname="detail" width="800" height="600" operationCode="detail"></t:dgToolBar>
