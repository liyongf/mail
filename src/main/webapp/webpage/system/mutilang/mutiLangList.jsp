...
<t:base type="jquery,easyui,tools"/>
  <t:datagrid name="mutiLangList" title="lang.maintain" actionUrl="mutiLangController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="id" sortOrder="desc">
   ...
   <t:dgToolBar title="common.add.param" langArg="common.language" icon="icon-add" url="mutiLangController.do?addorupdate" funname="add" operationCode="add"></t:dgToolBar>
   <t:dgToolBar title="common.edit.param" langArg="common.language" icon="icon-edit" url="mutiLangController.do?addorupdate" funname="update" operationCode="update" ></t:dgToolBar>
   <t:dgToolBar title="common.view" icon="icon-search" url="mutiLangController.do?detail" funname="detail" operationCode="detail" ></t:dgToolBar>
   <t:dgToolBar title="common.refresh" icon="icon-search" url="mutiLangController.do?refreshCach" funname="doSubmit" operationCode="refresh" ></t:dgToolBar>
  </t:datagrid>
