...
<t:datagrid name="operationList" title="operate.manage.data" actionUrl="functionController.do?ruledategrid&functionId=${functionId}" idField="id">
	...
	<t:dgToolBar title="common.add.param" langArg="common.operation" icon="icon-add" url="functionController.do?addorupdaterule&functionId=${functionId}" funname="add" operationCode="add" ></t:dgToolBar>
	</t:datagrid>
