...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsSqlList" checkbox="true" fitColumns="false" title="common.businessSqlTable" actionUrl="tSSmsSqlController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="common.add_2" icon="icon-add" url="tSSmsSqlController.do?goAdd" funname="add" operationCode="add"></t:dgToolBar>
   <t:dgToolBar title="common.edit_2" icon="icon-edit" url="tSSmsSqlController.do?goUpdate" funname="update" operationCode="update"></t:dgToolBar>
   <t:dgToolBar title="common.batchDelete"  icon="icon-remove" url="tSSmsSqlController.do?doBatchDel" funname="deleteALLSelect" operationCode="batchdelete"></t:dgToolBar>
   <t:dgToolBar title="common.view" icon="icon-search" url="tSSmsSqlController.do?goUpdate" funname="detail" operationCode="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>