...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsTemplateSqlList" checkbox="true" fitColumns="false" title="common.sqlDataTable" actionUrl="tSSmsTemplateSqlController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="common.add" icon="icon-add" url="tSSmsTemplateSqlController.do?goAdd" funname="add" operationCode="add"></t:dgToolBar>
   <t:dgToolBar title="common.edit" icon="icon-edit" url="tSSmsTemplateSqlController.do?goUpdate" funname="update" operationCode="update"></t:dgToolBar>
   <t:dgToolBar title="common.batch.delete"  icon="icon-remove" url="tSSmsTemplateSqlController.do?doBatchDel" funname="deleteALLSelect" operationCode="batchdelete"></t:dgToolBar>
   <t:dgToolBar title="common.view" icon="icon-search" url="tSSmsTemplateSqlController.do?goUpdate" funname="detail" operationCode="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
