...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="common.department.list" actionUrl="departController.do?departgrid" treegrid="true" idField="departid" pagination="false">
            ...
            <t:dgCol title="简拼" field="spelling" query="false" treefield="fieldMap.spelling"></t:dgCol>
            <t:dgCol title="全拼" field="fullSpelling" query="false" treefield="fieldMap.fullSpelling"></t:dgCol>
        ...
        <div id="departListtb" style="padding: 3px; height: 25px">
            <div style="float: left;">
                ...
                <a href="#" class="easyui-linkbutton" plain="true" icon="icon-putout" onclick="createSpell()"><t:mutiLang langKey="批量创建检索" langArg="common.department"/></a>
            </div>
        </div>
    </div>
</div>
...
function createSe(saveOld){
    $.ajax({
        url: 'departController.do?createSpell',
        type: 'post',
        async:false,
        data:{
            saveOld:saveOld
