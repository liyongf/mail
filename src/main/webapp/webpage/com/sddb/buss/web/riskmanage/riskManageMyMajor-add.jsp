...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="riskManageController.do?doAddMyMajor">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value">
					...
					<input id="majorId" name="majorId" type="hidden" style="width: 150px" class="inputxt" datatype="*" >
