...
<div class="easyui-layout" fit="true"  id="main_majorHiddenDangerList">
    <div region="center" style="padding:0px;border:0px" >
        ...
        <div class="easyui-layout" fit="true" id="main_typegroup_list">
            <div region="center" style="padding:0px;border:0px">
                <t:datagrid name="riskManageResultList" checkbox="true" pagination="true" fitColumns="true" title="管控任务结果" actionUrl="riskManageResultController.do?relRiskDatagrid&manageType=${manageType}&taskAllId=${taskAllId}" idField="id" fit="true" queryMode="group">
...
<script type="text/javascript">
    ...
    function showHazardFactorsList(id){
        ...
        $('#hazardFactorListpanel').panel("refresh", "riskManageResultController.do?hazardFactorList&taskAllId=${taskAllId}&load=add&taskManageId="+id);
    }
