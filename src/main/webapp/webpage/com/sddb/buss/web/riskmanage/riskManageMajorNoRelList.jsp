...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskMajorNoRelList" checkbox="true" pagination="true" fitColumns="false" title="" actionUrl="hazardFactorsController.do?datagridModuleHazardRel&modularId=${modularId}&rel=${rel}&riskType=${riskType}" idField="id" fit="true" queryMode="group">
            ...
            <t:dgToolBar title="添加关联" icon="icon-add"  width="500"  funname="addMajorRel" ></t:dgToolBar>
        </t:datagrid>
    </div>
</div>
<script type="text/javascript" src="plug-in/showvalue/showvalue.js"></script>
<script type="text/javascript">
    window.top["reload_riskMajorNoRelList"]=function(){
        $("#riskMajorNoRelList").datagrid( "load");
    };
    function addMajorRel() {
