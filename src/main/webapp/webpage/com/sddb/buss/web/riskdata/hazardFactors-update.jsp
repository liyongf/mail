	 ...
	 <script type="text/javascript">
         ...
         $(function() {
             magicsuggestPostNameSelSelected = $('#magicsuggestPostName').magicSuggest({
                 ...
                 value:["${hazardFactorsPage.postName}"],
             ...
             var modifySelect = getUserMagicSuggestWithValue($("#modifySelect"), $("#reviewMan"), "${hazardFactorsPage.reviewMan}", false);
         });
	 </script>
 </head>
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hazardFactorsController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value">
					<textarea  id="hazardFactors" name="hazardFactors" cols="6" style="width: 80%" <c:if test="${jinqiao eq 'true'}">datatype="*2-500"</c:if> <c:if test="${jinqiao ne 'true'}">datatype="*2-200"</c:if>>${hazardFactorsPage.hazardFactors}</textarea>
					<span class="Validform_checktip"></span>
