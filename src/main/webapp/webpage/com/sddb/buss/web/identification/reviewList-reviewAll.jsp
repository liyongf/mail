...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="riskIdentificationController.do?saveAllApproval" callback="@Override noteSubmitCallback" >
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr class="pass">
            ...
            <td class="value">
                <input id="modifyDate" name="modifyDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})" datatype="*"
                       ignore="checked" value='<fmt:formatDate value='${modifyDate}' type="date" pattern="yyyy-MM-dd"/>'>
        ...
        <tr class="rollBack" style="display: none">
            ...
            <td class="value">
                <textarea name="rollBackRemark" id="rollBackRemark" class="inputxt" style="width: 280px; height: 100px;"></textarea>
                <span class="Validform_checktip"></span>
