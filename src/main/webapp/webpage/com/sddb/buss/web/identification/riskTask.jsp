			...
			<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable" id="tab">
				<tr>
					...
					<td class="value" colspan="3">
						<t:dictSelect field="taskType" type="list" extendJson="{\"datatype\":\"*\"}"
				...
				<tr>
					...
					<td class="value" colspan="3">
						<input class="inputxt" id="taskName" name="taskName" datatype="*"  value="${riskTaskPage.taskName}" />
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">辨识活动名称</label>
					</td>
				</tr>
				<tr id="speIdeTypeTr" <c:if test="${'3' ne riskTaskPage.taskType}">style="display: none;"</c:if>>
					...
					<td class="value" colspan="3">
						<c:if test="${'3' ne riskTaskPage.taskType}">
							<t:dictSelect field="speIdeType" type="list"  id="speIdeType"
						...
						<c:if test="${'3' eq riskTaskPage.taskType}">
							<t:dictSelect field="speIdeType" type="list"  id="speIdeType" extendJson="{\"datatype\":\"*\"}"
										  typeGroupCode="specificType"  hasLabel="false" defaultVal="${riskTaskPage.speIdeType}" title="专项辨识类型"></t:dictSelect>
						</c:if>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
						<input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" id="startDate" name="startDate" datatype="*"     value="<fmt:formatDate value='${startDate}' type="date" pattern="yyyy-MM-dd"/>" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
						<input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" id="endDate" name="endDate" datatype="*"    value="<fmt:formatDate value='${riskTaskPage.endDate}' type="date" pattern="yyyy-MM-dd"/>" />
						<span class="Validform_checktip"></span>
