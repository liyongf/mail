...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskList" checkbox="true" pagination="true" fitColumns="false" title="风险列表" actionUrl="riskManageController.do?riskDatagrid&identificationType=${identificationType}&manageType=${manageType}" idField="id" fit="true" queryMode="group">
    ...
    api.button(
            {
                ...
                callback: function(){
                    ...
                    if(rows.length <=0){
                        ...
                        ids.join(',');
                        $.ajax({
                            url: "riskManageController.do?saveRelRisk&manageType=${manageType}&ids="+ids+"&tt="+new Date(),
                            type: 'POST',
                            error: function(){
                            },
