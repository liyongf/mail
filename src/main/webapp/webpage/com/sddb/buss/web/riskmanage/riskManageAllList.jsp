...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskManageTaskAllList" checkbox="true" pagination="true" fitColumns="true" title="${riskManageName}任务" actionUrl="riskManageTaskController.do?datagrid&manageType=${manageType}" idField="id" fit="true" queryMode="group">
            ...
            <t:dgToolBar title="添加任务" icon="icon-add" url="riskManageTaskController.do?goAdd&manageType=${manageType}" funname="add" operationCode="add"></t:dgToolBar>
            <t:dgToolBar title="编辑" icon="icon-edit" url="riskManageTaskController.do?goUpdate" funname="update" operationCode="update" ></t:dgToolBar>
            <%--<t:dgToolBar title="查看" icon="icon-search" url="riskManageTaskController.do?goDetail" funname="detail"></t:dgToolBar>--%>
            <t:dgToolBar title="删除"  icon="icon-remove" url="riskManageTaskController.do?doBatchDelAll" funname="deleteALLSelect" operationCode="batchdelete" ></t:dgToolBar>
