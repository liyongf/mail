...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskManageRecordPostList" checkbox="true" pagination="true" fitColumns="true" title="岗位管控记录" actionUrl="riskManageTaskController.do?recordPostDatagrid" idField="id" fit="true" queryMode="group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var datagrid = $("#riskManageRecordPostListtb");
        $("#riskManageRecordPostListForm").append($("#tempSearchColums div[name='manageUserColums']").html());
        ...
        $("input[name='queryHandleStatusTem']").change(function() {
            ...
            riskManageRecordPostListsearch();
        });


    });

    window.top["reload_riskManageRecordPostList"]=function(){
        $("#riskManageRecordPostList").datagrid("reload");
        /*riskManageRecordPostListsearch();*/
    };
