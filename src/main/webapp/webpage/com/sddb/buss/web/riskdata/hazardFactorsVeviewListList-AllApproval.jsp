...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hazardFactorsController.do?saveAllApproval" callback="@Override noteSubmitCallback" >
