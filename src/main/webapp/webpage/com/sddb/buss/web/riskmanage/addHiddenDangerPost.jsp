...
<html>
  ...
  <script type="text/javascript">
	  ...
	  $(function() {
		  ...
		  function callbackFun(data){
              window.top["reload_hazardFactorsPostList_${riskManagePostTaskEntity.id}"].call();
 ...
 <body>
  <t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="tBHiddenDangerExamController.do?doAdd" tiptype="3" btnsub="btn" callback="callbackFun">
	  ...
	  <input id="examType" name="examType" type="hidden" value="${riskManagePostTaskEntity.manageType}">
	  <input id="manageType" name="manageType" type="hidden" value="${riskManagePostTaskEntity.manageType}">
	  <input id="riskType" name="riskType" type="hidden" value="${postRisk.riskType}">
	  <input id="addThree" name="addThree" type="hidden" value="0"/>
	  <input id="riskManagePostHazardFactorId" name="riskManagePostHazardFactorId" type="hidden" value="${riskManagePostHazardFactorId}">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect field="manageType" type="list" extendJson="{\"datatype\":\"*\"}"
							  typeGroupCode="manageType" defaultVal="${riskManagePostTaskEntity.manageType}" hasLabel="false"  title="信息来源" readonly="readonly"></t:dictSelect>
		...
		<tr>
		  ...
		  <td class="value">
			  <t:dictSelect field="riskType" type="list" extendJson="{\"datatype\":\"*\"}"
							typeGroupCode="risk_type" defaultVal="${postRisk.riskType}" hasLabel="false"  title="风险类型" readonly="readonly"></t:dictSelect>
	  ...
	  <tr>
		  ...
		  <td class="value" colspan="3">
			  ...
			  <input type="hidden" name="riskIdHazard" id="riskId" value="" style="width: 150px" class="inputxt"  >
	...
	<tr>
		...
		<td class="value" colspan="3">
			<textarea id="problemDesc" name="problemDesc" type="text" style="width: 440px;"  datatype="*" >${hazardFactorPost.hazardFactors}</textarea>
