...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="riskManageTaskController.do?doAddPost" beforeSubmit="showWait" callback="@Override hideWait">
	  ...
	  <input id="manageType" name="manageType" type="hidden" style="width: 150px" datatype="*" value="post">
