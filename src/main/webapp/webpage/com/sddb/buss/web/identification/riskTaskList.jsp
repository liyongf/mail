...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
      <t:datagrid name="riskTaskList" title="风险辨识任务" fitColumns="false" checkbox="false"
                  actionUrl="riskTaskController.do?datagrid" idField="id" fit="true" queryMode="group" sortOrder="desc" sortName="createDate">
          ...
          <t:dgFunOpt funname="addRisk(id,taskType)" title="开始辨识"  urlclass="ace_button" exp="participant#eq#0"></t:dgFunOpt>
          ...
          <t:dgFunOpt funname="addParticipantMan(id,status)" title="追加人员"  urlclass="ace_button"/>
          <%--<t:dgFunOpt funname="ExportDoc(id,taskType)" title="生成辨识报告"  urlclass="ace_button" exp="organizerOrCreateBy#eq#0&&exportDoc#eq#0"></t:dgFunOpt>--%>
          <t:dgFunOpt funname="deleteSelect(id)" title="删除"  urlclass="ace_button" exp="organizerOrCreateBy#eq#0"/>
          <t:dgToolBar title="录入" icon="icon-add" url="riskTaskController.do?addorupdate" funname="add" height="450" width="850" operationCode="add"></t:dgToolBar>
...
<script type="text/javascript">
    ...
    function addParticipantMan(id,status){
        if(status=="1"){
            tip("任务已完成");
        }else {
            var url = "riskTaskController.do?addorupdate&participantMan=true&id="+id;

            createwindow("追加人员",url,"850","450");
        }
