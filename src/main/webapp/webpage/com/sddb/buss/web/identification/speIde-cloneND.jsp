...
//                          frameElement.api.close();
 ...
 <body>
 <t:datagrid name="hazardFactorsList" checkbox="false" pagination="true" fitColumns="false" pageSize="5" title="选择克隆风险点" height="5000px" actionUrl="riskIdentificationController.do?cloneDatagrid&identificationType=${identificationType}" idField="id" fit="true" queryMode="group">
