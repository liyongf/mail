     ...
     <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
         <tr>
             ...
             <td class="value">
                 <t:dictSelect field="speIdeType" type="list"  id="speIdeType"
                               typeGroupCode="specificType"  hasLabel="false" title="专项辨识类型"></t:dictSelect>
         ...
         <tr>
             ...
             <td class="value">
                 ...
                 <span class="Validform_checktip"></span>
                 <label class="Validform_label" style="display: none;">专项辨识活动</label>
             </td>
         </tr>
 ...
 <script>
     $(document).ready(function(){
         ...
         var speIdeTaskSelect = $('#speIdeTaskSelect').magicSuggest({
             ...
             data:'magicSelectController.do?getSpeIdeTask&riskTaskId=${riskTaskId}',
             valueField:'id',
             placeholder:'输入或选择',
             maxSelection:1,
             selectFirst: true,
         ...
         $("#speIdeType").on("change",function(){
             var speIdeType = $("#speIdeType>option:selected").val();
             speIdeTaskSelect.setData("magicSelectController.do?getSpeIdeTask&riskTaskId=${riskTaskId}&speIdeType="+speIdeType);
         })
     })
 </script>
 </body>
