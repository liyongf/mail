...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tBHiddenDangerExamList" checkbox="true"  onDblClick="dblClickDetail" onLoadSuccess="loadSuccess" autoLoadData="true" fitColumns="false" title="隐患列表"
                    actionUrl="riskManageResultController.do?taskAllRelHdDatagrid&riskManageTaskAllId=${riskManageTaskAllId}"
                    idField="id" sortName="examDate" sortOrder="desc" fit="true" queryMode="group">
            <t:dgCol title="隐患检查id"  field="id" hidden="true" query="false" queryMode="single"  sortable="true" width="80" align="center"></t:dgCol>
            <t:dgCol title="隐患处理id"  field="handleEntity.id" hidden="true" query="false" queryMode="single"  sortable="true" width="80" align="center"></t:dgCol>
            <t:dgCol title="隐患来源"  field="origin" hidden="true" query="false" dictionary="hiddenDangerOrigin" queryMode="single"  sortable="true" width="80" align="center"></t:dgCol>
            <t:dgCol title="发现时间"  field="examDate"  formatter="yyyy-MM-dd"  query="true" queryMode="group"  sortable="true" width="80" align="center"></t:dgCol>
            <t:dgCol title="检查班次"  field="shift" hidden="false" dictionary="workShift" query="false"  queryMode="single"  sortable="true" width="80" align="center"></t:dgCol>
            ...
            <t:dgCol title="责任部门"  field="dutyUnit.departname" query="false" queryMode="single"  sortable="false" width="80" align="center"></t:dgCol>
            ...
            <t:dgCol title="信息来源"  field="manageType"  query="false" dictionary="manageType" queryMode="single"  sortable="true" width="120" align="center"></t:dgCol>
            <t:dgCol title="隐患等级"  field="hiddenNature"  query="false" dictionary="hiddenLevel"  queryMode="single"  sortable="true" width="80" align="center"></t:dgCol>
            <c:if test="${newPost ne 'true' and manageType eq 'post'}">
                <t:dgCol title="岗位"  field="post.postName"     queryMode="single"  width="80" align="center"></t:dgCol>
            </c:if>
            ...
            <c:if test="${beixulou eq 'true'}">
                <t:dgCol title="限期班次"  field="limitShift" dictionary="workShift" width="80" align="center"></t:dgCol>
            </c:if>
            ...
            <t:dgCol title="整改日期"  field="handleEntity.modifyDate" formatter="yyyy-MM-dd" query="false"  queryMode="single"  sortable="true" width="80" align="center"></t:dgCol>
            ...
            <t:dgCol title="处理状态"  field="handleEntity.handlelStatus" dictionary="handelStatus" query="false"  queryMode="single"  sortable="true" width="60" align="center"></t:dgCol>

            <t:dgCol title="驳回备注"  field="handleEntity.rollBackRemark"  hidden="true" query="false" queryMode="group"  sortable="false" width="300"></t:dgCol>
            <t:dgCol title="录入人"  field="handleEntity.createName"   queryMode="group"  sortable="true" width="120" align="center"></t:dgCol>
            <t:dgCol title="创建人登录名称"  field="handleEntity.createBy"  hidden="true"  queryMode="group"  sortable="true" width="120" align="center"></t:dgCol>
            <t:dgCol title="录入日期"  field="handleEntity.createDate" formatter="yyyy-MM-dd"  queryMode="group"  sortable="true" width="120" align="center"></t:dgCol>
            <t:dgCol title="更新人名称"  field="handleEntity.updateName"  hidden="true"  queryMode="group"  sortable="true" width="120" align="center"></t:dgCol>
            <t:dgCol title="更新人登录名称"  field="handleEntity.updateBy"  hidden="true"  queryMode="group"  sortable="true" width="120" align="center"></t:dgCol>
            <t:dgCol title="更新日期"  field="handleEntity.updateDate" formatter="yyyy-MM-dd" hidden="true"  queryMode="group"  sortable="true" width="120" align="center"></t:dgCol>
...
<script type="text/javascript">
    ...
    function replaceProblemDesc(){
        var problemDescCells = $("td[field='problemDesc']:gt(0)");
...
//            return;
//        }
//        url += '&load=detail&id='+rowsData[0]["handleEntity.id"];
//        createdetailwindow(title,url,width,height);
        ...
        if(rowsData == null || rowsData.length != 1){
            ...
            addOneTab("查看","riskManageResultController.do?updateHd&load=detail&manageType=${manageType}&id="+rowsData[0]["id"],"default");
        }
    }
    ...
    function gotoUpdate(){
        ...
        if(rowsData == null || rowsData.length != 1){
            ...
            addOneTab("编辑","riskManageResultController.do?updateHd&taskAll=true&id="+rowsData[0]["id"],"default");
        }
    }
