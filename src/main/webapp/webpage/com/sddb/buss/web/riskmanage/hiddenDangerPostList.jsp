...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tBHiddenDangerExamList" checkbox="true"  onDblClick="dblClickDetail" onLoadSuccess="loadSuccess" autoLoadData="true" fitColumns="false" title="隐患列表"
                    actionUrl="riskManageResultController.do?hazardFactorPostRelHdDatagrid&riskManagePostHazardFactor.id=${riskManagePostHazardFactorId}&riskManageTaskAllId=${riskManageTaskAllId}"
...
//        createdetailwindow(title,url,width,height);
        ...
        if(rowsData == null || rowsData.length != 1){
            ...
            addOneTab("查看","riskManageResultController.do?updateHd&load=detail&id="+rowsData[0]["hd.id"],"default");
        }
    }
