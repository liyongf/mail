...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskManageRecordList" checkbox="true" pagination="true" fitColumns="true" title="任务记录" actionUrl="riskManageTaskController.do?recordDatagrid" idField="id" fit="true" queryMode="group">
            ...
            <t:dgCol title="管控名称"  field="taskAllManage.manageName"   queryMode="group"  width="120" align="center"></t:dgCol>
            ...
            <t:dgFunOpt funname="showRiskManageTask(id)" title="查看"  urlclass="ace_button" ></t:dgFunOpt>
        </t:datagrid>
    </div>
</div>
<script type="text/javascript">
    ...
    function showRiskManageTask(id){
        $.ajax({
            url : "riskManageController.do?getManageType",
            type : 'post',
            cache : false,
            async: true,
            data : {
            ...
            success : function(data) {
                var manage = $.parseJSON(data);
                if (manage=="comprehensive"||manage=="profession"||manage=="team"||manage=="group"||manage=="post") {
