...
<html>
 ...
 <body >
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="riskManageTaskAllManageController.do?saveXC" beforeSubmit="showWait" callback="@Override hideWait">
				...
				<tr>
					...
					<td class="value" colspan="5">
						...
						<span style="width:180px;display: inline-block;">
							<label>
									<input name="major" value="${major.typecode}" type="checkbox">${major.typename}
								</label>
						</span>
						</c:forEach>
					</td>
