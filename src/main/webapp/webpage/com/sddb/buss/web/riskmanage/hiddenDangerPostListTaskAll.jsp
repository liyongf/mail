...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tBHiddenDangerExamList" checkbox="true"  onDblClick="dblClickDetail" onLoadSuccess="loadSuccess" autoLoadData="true" fitColumns="false" title="隐患列表"
                    actionUrl="riskManageResultController.do?taskAllPostRelHdDatagrid&riskManageTaskAllId=${riskManageTaskAllId}"
...
//        createdetailwindow(title,url,width,height);
        ...
        if(rowsData == null || rowsData.length != 1){
            ...
            addOneTab("查看","riskManageResultController.do?updateHd&load=detail&id="+rowsData[0]["id"],"default");
        }
    }
    ...
    window.top["reload_hdList_${riskManagePostHazardFactorId}"]=function(){
        $("#tBHiddenDangerExamList").datagrid( "reload");
        //alert('reload_hazardFactorsList_');
        //debugger;
        //hazardFactorsListsearch();
    };
    window.top["tip_hdList_${riskManagePostHazardFactorId}"]=function(){
        tip(this.msg);
    };
</script>
