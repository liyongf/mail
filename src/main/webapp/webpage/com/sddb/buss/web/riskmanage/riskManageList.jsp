...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskManageList" checkbox="true" pagination="true" fitColumns="true" title="${riskManageName}清单" actionUrl="riskManageController.do?relRiskDatagrid&manageType=${manageType}" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
            ...
            <t:dgCol title="风险描述"  field="risk.riskDesc"   queryMode="group" formatterjs="valueTitle" width="200"></t:dgCol>
            ...
            <t:dgToolBar title="删除"  icon="icon-remove" url="riskManageController.do?doBatchDel&riskManageAll=true" funname="deleteALLSelect" operationCode="batchdelete" ></t:dgToolBar>
...
<script type="text/javascript">
    ...
    function selectRisk(){
        $.dialog({id:'dialog',title:'风险添加',zIndex:2100,modal:true,content: 'url:riskManageController.do?selectRisk&manageType=${manageType}',lock:true,width: 1200,height: 600});
    }
    ...
    function ExportXls() {
        ...
        if (rows.length == 0) {
            JeecgExcelExport("riskManageController.do?exportXls&manageType=${manageType}", "riskManageList");
