...
<html>
<head>
    <title>风险管控效果分析</title>
</head>
<body style="width: 99%">
<table style="width: 100%;height: auto">
    <tr>
        <td style="text-align: center">
            <form id="thisForm" action="tBDecisionAnalyseController.do?riskHiddenStatistics&type=year" method="post">
            ...
            <span style="vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 100px;text-align:right;"
             ...
             <span style="vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 190px;text-align:left;text-overflow:ellipsis;-o-text-overflow:ellipsis;">
                ...
                <t:dictSelect field="riskType" type="list" extendJson="{\"datatype\":\"*\"}"
                              typeGroupCode="risk_type"  hasLabel="false"  title="风险类型" defaultVal="${riskType}"></t:dictSelect>&nbsp;&nbsp;
...
<%--下面添加统计图表--%>
    ...
    <t:datagrid name="lineList" fitColumns="true" title="${year}风险管控效果分析" pagination="false"
                onLoadSuccess = "tipMsg" actionUrl="tBDecisionAnalyseController.do?mineYearRiskTrendDatagrid&year=${year}&addressId=${addressId}&riskType=${riskType}"
