...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="sfMineStandardAssessList" checkbox="true" fitColumns="true" title="排土" actionUrl="sfMineStandardAssessController.do?datagrid&mineType=${mineType}&assessType=${assessType}" idField="id" fit="true" queryMode="group">
