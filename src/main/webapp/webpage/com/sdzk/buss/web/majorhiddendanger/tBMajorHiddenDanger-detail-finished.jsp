 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value">
                    <fmt:formatDate value='${tBMajorHiddenDangerPage.reviewTime}' type="date" pattern="yyyy-MM-dd"/>
				</td>
				<td align="right">
					<label class="Validform_label">
						复查人:
				...
				<td class="value">
                        ${tBMajorHiddenDangerPage.reviewerName}
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td class="value" colspan="3">
                        ${tBMajorHiddenDangerPage.reviewReport}
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td class="value" colspan="3">
                    <fmt:formatDate value='${tBMajorHiddenDangerPage.cancelDate }' type="date" pattern="yyyy-MM-dd"/>
				</td>
			</tr>
			</table>
		</t:formvalid>
