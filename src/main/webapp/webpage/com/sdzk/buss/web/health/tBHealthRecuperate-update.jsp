		...
		<tr>
			     ...
			     <td colspan='4' align="center" ><strong>疗养信息</strong></td>
					...
					<tr>
						...
						<td class="value">
									  <input id="recupDate" name="recupDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})" value='<fmt:formatDate value='${tBHealthRecuperatePage.recupDate}' type="date" pattern="yyyy-MM-dd"/>'>
						...
						<td class="value">
						     	 <input id="recupCycle" name="recupCycle" type="text" style="width: 150px" class="inputxt"  value='${tBHealthRecuperatePage.recupCycle}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="nextRecupDate" name="nextRecupDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${tBHealthRecuperatePage.nextRecupDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="thisYearIsRecup" name="thisYearIsRecup" type="text" style="width: 150px" class="inputxt"  value='${tBHealthRecuperatePage.thisYearIsRecup}'>
							<span class="Validform_checktip"></span>
