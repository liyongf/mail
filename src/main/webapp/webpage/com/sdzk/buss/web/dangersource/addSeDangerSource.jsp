...
<body>
<t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="tBDangerSourceController.do?doAddSeDangerSource" tiptype="3" callback="showTips" btnsub="btn_sub">
...
<tr>
    ...
    <td class="value">
        <input id="yeRecognizeTime" name="yeRecognizeTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()" datatype="*" />
...
<%--<c:if test="${initParam.les == 'yes'}">--%>
    <%--<tr>--%>
        ...
        <%--</td>--%>
        <%--<td class="value">--%>
            <%--<t:dictSelect id="lecRiskPossibility" field="lecRiskPossibility" datatype="*" typeGroupCode="lec_risk_probability" extendJson="{'onchange':'fillFXDJFXZ();'}" hasLabel="false" defaultVal=""></t:dictSelect>--%>
            <%--<span class="Validform_checktip"></span>--%>
            <%--<label class="Validform_label" style="display: none;">风险可能性</label>--%>
        <%--</td>--%>
        <%--<td align="right">--%>
        ...
        <%--</td>--%>
        <%--<td class="value">--%>
            <%--<t:dictSelect id="lecRiskLoss" field="lecRiskLoss" datatype="*" typeGroupCode="lec_risk_loss" extendJson="{'onchange':'fillFXDJFXZ();'}" hasLabel="false" defaultVal=""></t:dictSelect>--%>
            <%--<span class="Validform_checktip"></span>--%>
            <%--<label class="Validform_label" style="display: none;">风险损失</label>--%>
        <%--</td>--%>
    <%--</tr>--%>
    ...
    <%--<tr>--%>
        ...
        <%--</td>--%>
        <%--<td class="value">--%>
            <%--<t:dictSelect id="lec" field="lecExposure" datatype="*" typeGroupCode="lec_exposure" extendJson="{'onchange':'fillFXDJFXZ();'}" hasLabel="false" defaultVal=""></t:dictSelect>--%>
            <%--<span class="Validform_checktip"></span>--%>
        ...
        <%--</td>--%>
        <%--<td class="value">--%>
            <%--<input id="lecRiskValue" name="lecRiskValue" type="text" style="width: 150px" class="inputxt" value="">--%>
            <%--<span class="Validform_checktip"></span>--%>
            <%--<label class="Validform_label" style="display: none;">风险值</label>--%>
        <%--</td>--%>
    <%--</tr>--%>
