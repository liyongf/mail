 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
							<div id="controllerSelect" style="width: 130px;height: 15px"></div>
						     	 <input id="controller" name="controller" type="hidden" datatype="*" style="width: 150px" class="inputxt"
						     	 value='${tBDsManageRecordPage.controller}'>
					...
					<tr>
						...
						<td class="value">
									  <input id="controlleDate" name="controlleDate" type="text" datatype="*" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
									    value='<fmt:formatDate value='${tBDsManageRecordPage.controlleDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<textarea id="workContent" name="workContent" rows="6" class="inputxt" datatype="*" style="height: auto;width: 80%" >${tBDsManageRecordPage.workContent}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<textarea id="achieveEffect" name="achieveEffect" rows="6" class="inputxt" datatype="*" style="height: auto;width: 80%" >${tBDsManageRecordPage.achieveEffect}</textarea>
							<span class="Validform_checktip"></span>
