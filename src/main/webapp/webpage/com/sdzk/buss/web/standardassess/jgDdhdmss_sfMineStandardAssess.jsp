...
<tr>
    ...
    <td class="value" style="text-align: left;" colspan="6">
        <input id="ssaSumScore" name="ssaSumScore" type="text" style="width: 150px" class="inputxt" value="${sfMineStandardAssessPage.ssaSumScore}" datatype="/^100(\.0+)$|^(\d|[1-9]\d)(\.\d+)*$/" errormsg="请填写100以内的数字!">
        <span class="Validform_checktip"></span>
