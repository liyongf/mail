...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBDangerSourceList" checkbox="true" fitColumns="false" title="危险源列表" actionUrl="tBDangerSourceController.do?initChooseDanger" idField="id" fit="true" queryMode="group" onLoadSuccess="loadSuccess">
    ...
    api.button(
            {
                ...
                callback: function(){
                    ...
                    if(rows.length <=0){
                        ...
                        ids.join(',');
                        $.ajax({
                            url: "tBDangerSourceController.do?saveChooseDanger&ids="+ids+"&tt="+new Date(),
                            type: 'POST',
                            error: function(){
                            },
