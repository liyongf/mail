...
<html>
 <head>
  ...
  $(function(){
	  ...
	  getAddressMagicSuggestWithValue($('#hdLocationSelect'), $("#hdLocation"),"${tBMajorHiddenDangerPage.hdLocation}",false);
	  ...
	  var magicsuggestDutyUnitSelSelected = $('#magicsuggestDutyUnitSel').magicSuggest({
		  ...
		  maxSelection:1,
		  selectFirst: true,
		  <c:if test="${not empty tBMajorHiddenDangerPage.dutyUnit.id}">
		  value:['${tBMajorHiddenDangerPage.dutyUnit.id}'],
		  </c:if>
		  highlight: false,
      ...
      var magicsuggestDutyManSelected = getUserMagicSuggestAllowFreeEntries($('#magicsuggestDutyMan'),  $("#dutyMan"), "${tBMajorHiddenDangerPage.dutyMan}", false);
  ...
  function fillKeyWords(){
      var str = '${tBMajorHiddenDangerPage.keyWords}';
      var strKeyWords=new Array(); //定义数组
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" layout="table" action="tBMajorHiddenDangerController.do?doUpdate" callback="@Override noteSubmitCallbackAdd" tiptype="3">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
							<div id="hdLocationSelect" style="width: 130px;height: 15px"></div>
						     	 <input id="hdLocation" name="hdLocation" type="hidden" style="width: 150px" class="inputxt"  datatype="*" value='${tBMajorHiddenDangerPage.hdLocation}'>
						...
						<td class="value">
									  <input id="inveDate" name="inveDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})" datatype="*"
									    value='<fmt:formatDate value='${tBMajorHiddenDangerPage.inveDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<t:dictSelect id="hdInfoSource" field="hdInfoSource" defaultVal="${tBMajorHiddenDangerPage.hdInfoSource}" typeGroupCode="hiddenFrom" hasLabel="false" extendJson="{\"datatype\":\"*\"}" ></t:dictSelect>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
							<%--<t:dictSelect id="hdLevel" field="hdLevel" defaultVal="${tBMajorHiddenDangerPage.hdLevel}" typeGroupCode="hiddenLevel" hasLabel="false" extendJson="{\"datatype\":\"*\"}" ></t:dictSelect>--%>
					...
					<tr>
						...
						<td class="value">
							<t:dictSelect id="hdCate" field="hdCate" defaultVal="${tBMajorHiddenDangerPage.hdCate}" typeGroupCode="hiddenCate" hasLabel="false" extendJson="{\"datatype\":\"*\"}" ></t:dictSelect>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
							<t:dictSelect id="hdMajor" field="hdMajor" defaultVal="${tBMajorHiddenDangerPage.hdMajor}" typeGroupCode="proCate_gradeControl" hasLabel="false" extendJson="{\"datatype\":\"*\"}" ></t:dictSelect>
							<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value" colspan="3">
					<t:dictSelect id="hiddenType" field="hiddenType" defaultVal="${tBMajorHiddenDangerPage.hiddenType}" typeGroupCode="hiddenType" hasLabel="false" extendJson="{\"datatype\":\"*\"}" ></t:dictSelect>
					<span class="Validform_checktip"></span>
        ...
        <%--&lt;%&ndash;关键字——结束&ndash;%&gt;--%>
                    <%--<tr>--%>
                        ...
                        <%--</td>--%>
                        <%--<td class="value" colspan="3">--%>
                            <%--<input id="dangerId.id" name="dangerId.id" type="hidden" datatype="*" style="width: 150px" class="inputxt" nullmsg="请选择危险源！" value="${tBMajorHiddenDangerPage.dangerId.id}">--%>
                            <%--<textarea id="dangerName" name="dangerName" style="width: 440px;" onclick="choose_dangerSource('选择危险源');">${tBMajorHiddenDangerPage.dangerId.hazard.hazardName}</textarea>--%>
                            <%--<span class="Validform_checktip"></span>--%>
				...
				<tr>
					...
					<td class="value">
						...
						<input id="dutyUnitId" name="dutyUnit.id" type="hidden" style="width: 150px" value="${tBMajorHiddenDangerPage.dutyUnit.id}" class="inputxt" datatype="*">
					...
					<td class="value">
						...
						<input type="hidden" name="dutyMan" id="dutyMan" value="${tBMajorHiddenDangerPage.dutyMan}" class="inputxt" datatype="*">
            ...
            <tr>
                ...
                <td class="value">
                    <input id="rectPeriod" name="rectPeriod" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" datatype="*"
                           value='<fmt:formatDate value='${tBMajorHiddenDangerPage.rectPeriod}' type="date" pattern="yyyy-MM-dd"/>'>
                    <span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
						<textarea id="hdDesc" name="hdDesc" style="width: 80%;height: auto;" class="inputxt" rows="6">${tBMajorHiddenDangerPage.hdDesc}</textarea>
						<span class="Validform_checktip"></span>
