...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBHiddenDangerExamList" onDblClick="dblClickDetail" checkbox="true" fitColumns="false" title="隐患检查" actionUrl="tBHiddenDangerExamController.do?datagrid&examType=${examType}" idField="id" fit="true" queryMode="group" sortName="examDate" sortOrder="desc">
   ...
   <%--<t:dgCol title="班次"  field="shift" hidden="false" dictionary="workShift" queryMode="single"  sortable="false" width="60"></t:dgCol>--%>
   <t:dgCol title="班次" field="shift"  dictionary="workShift" align="center" width="37"></t:dgCol>
   ...
   <t:dgCol title="检查人"  field="fillCardManNames" hidden="true"   queryMode="group"  sortable="false" width="67" align="center"></t:dgCol>
   <t:dgCol title="组别"  field="itemId"  queryMode="group"  dictionary="group" sortable="false" width="77" align="center"></t:dgCol>
   <t:dgCol title="组员"  field="itemUserNameTemp" formatterjs="valueTitle" queryMode="group"  sortable="false" width="100" align="center"></t:dgCol>

   <%--新增关键字部分--%>
   <%--<t:dgCol title="关键字"  field="keyWords" queryMode="group" sortable="false" width="57" align="center"></t:dgCol>--%>
   ...
   <t:dgCol title="隐患等级"  field="hiddenNature" hidden="true" dictionary="hiddenLevel" queryMode="group"  sortable="false" width="78" align="center"></t:dgCol>
   ...
   <t:dgCol title="经过路线"  field="routeLine" hidden="true"   queryMode="group"  sortable="false" width="120" align="center"></t:dgCol>
   ...
   <t:dgToolBar  title="录入" icon="icon-add" url="tBHiddenDangerExamController.do?goAdd&examType=${examType}" funname="gotoAdd"  width="950" height="400" operationCode="add"></t:dgToolBar>
   ...
   <t:dgToolBar title="导出" icon="icon-putout" funname="ExportXls" operationCode="export"></t:dgToolBar>
      ...
      <t:dgToolBar title="撤回" icon="icon-undo" url="tBHiddenDangerExamController.do?toReportCallback"  funname="toReportCallback" operationCode="undoReport"></t:dgToolBar>
      <t:dgToolBar title="上报" icon="icon-putout" url="tBHiddenDangerExamController.do?reportHiddenDanger"  funname="reportHiddenDanger" operationCode="report"></t:dgToolBar>
