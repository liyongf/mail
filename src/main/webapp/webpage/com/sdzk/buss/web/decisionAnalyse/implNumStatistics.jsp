...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type: 'POST',
            url: 'tBDecisionAnalyseController.do?implNumStatistics',
            data: {
                flag:"${flag}",
                startDate:"${startDate}",
                endDate:"${endDate}"
    ...
    function focus(param) {
        ...
        var url = "tBDecisionAnalyseController.do?riskManageStatisticsMenu&type=implNum&riskId="+riskId;
        if(${flag eq '1'}){
