 ...
 <head>
  ...
  <t:base type="jquery,easyui,tools,DatePicker"></t:base>
	 ...
	 <script type="text/javascript">
	  $(function(){
		 getUserMagicSuggest($("#leaderSelect"), $("#leader"));
		  getAddressMagicSuggest($("#locationSelect"), $("#location"));
	  });
  //编写自定义JS代码
  </script>
 </head>
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBSpecialEvaluationController.do?doAdd">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<t:dictSelect field="leaderType" typeGroupCode="evaluationLeaderType"  hasLabel="false" defaultVal="" datatype="*"/>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<input id="time" name="time" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})" value="<fmt:formatDate value='<%=new Date()%>' type="date" pattern="yyyy-MM-dd"/>"
							   datatype="*"
						/>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
								<input id="teamMembers" name="teamMembers" style="width: 440px;" datatype="*" type="text"
				...
				<tr>
					...
					<td class="value" colspan="3">
							<div id="locationSelect" style="width: 130px;height: 15px"></div>
					     	 <input id="location" name="location" type="hidden" style="width: 150px" class="inputxt"
									datatype="*"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
							<textarea id="remark" name="remark" style="width: 80%;height: auto" rows="6" class="inputxt" datatype="*"></textarea>
							<span class="Validform_checktip"></span>
