...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type: 'POST',
            url: 'tBDecisionAnalyseController.do?hazardFactortsNumStatistics',
            data: {
                flag:"${flag}",
                startDate:"${startDate}",
                endDate:"${endDate}"
    ...
    function focus(param) {
        ...
        var url = "tBDecisionAnalyseController.do?riskManageStatisticsMenu&type=hazardFactortsNum&riskId="+riskId;
        if(${flag eq '1'}){
