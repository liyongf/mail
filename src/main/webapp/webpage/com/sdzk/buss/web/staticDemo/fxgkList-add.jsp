...
<div id="main_depart_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBAccidentLevelList" onDblClick="dblClickDetail" checkbox="true" fitColumns="true"  title="风险数据库" actionUrl="statiController.do?fxListDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="queryUsersByDepart()" title="危害因素录入" urlclass="ace_button" urlStyle="background-color:#1a7bb9;" urlfont="fa-database"></t:dgFunOpt>
  </t:datagrid>
  </div>
 </div>
<div data-options="region:'east',
 ...
 function queryUsersByDepart(){
     ...
     $('#userListpanel').panel("refresh", "statiController.do?wxys2" );
 }
