...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wechatTemplateManagementController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="modelName" name="modelName" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
            			...
            			<t:dictSelect field="modelType" type="list"
                              typeGroupCode="wechat_model_type" hasLabel="false"  title="统计表类型"></t:dictSelect>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:600px;" class="inputxt" rows="4" id="modelContent" name="modelContent"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
