...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBAccidentLevelList" onDblClick="dblClickDetail" checkbox="true" width="900px" height="450px" fitColumns="true" title="危害因素" actionUrl="statiController.do?whysListDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="信息来源"  field="createBy" dictionary="d"  queryMode="single" query="true"  width="120" align="center"></t:dgCol>
  </t:datagrid>
  </div>
 </div>
