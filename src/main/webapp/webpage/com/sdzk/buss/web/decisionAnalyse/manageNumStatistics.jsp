...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            type: 'POST',
            url: 'tBDecisionAnalyseController.do?manageNumStatistics',
            data: {
                flag:"${flag}",
                startDate:"${startDate}",
                endDate:"${endDate}"
    ...
    function focus(param) {
        ...
        var url = "tBDecisionAnalyseController.do?riskManageStatisticsMenu&type=manageNum&riskId="+riskId;
        if(${flag eq '1'}){
