...
<%--<c:if test="${from ne 'mineAssess'}">--%>
    ...
    <%--<div class="wz-bt" >您当前的位置：考核评分管理->露天煤矿->安全风险分级管控</div>--%>
<%--</c:if>--%>
...
<tr style="height: 40px;">
    <td colspan='8' align="center" style="font-size:20px;font-weight: bold;">煤矿安全风险分级管控标准化评分</td>
</tr>
<tr>
...
<tr>
    ...
    <td class="td-padding">
        <label class="Validform_label">
            新水平、新采（盘）区、新工作面设计前，开展1次专项辨识： 1.专项辨识由总工程师组织有关业务科室进行； 2.重点辨识地质条件和重大灾害因素等方面存在的安全风险； 3.补充完善重大安全风险清单并制定相应管控措施； 4.辨识评估结果用于完善设计方案，指导生产工艺选择、生产系统布置、设备选型、劳动组织确定等
        </label>
    </td>
    <td>
...
<tr>
    <td class="td-padding">
        <label class="Validform_label">
            生产系统、生产工艺、主要设施设备、重大灾害因素（露天煤矿爆破参数、边坡参数）等发生重大变化时，开展1次专项辨识： 1.专项辨识由分管负责人组织有关业务科室进行； 2.重点辨识作业环境、生产过程、重大灾害因素和设施设备运行等方面存在的安全风险； 3.补充完善重大安全风险清单并制定相应的管控措施； 4.辨识评估结果用于指导重新编制或修订完善作业规程、操作规程
        </label>
    </td>
    <td>
...
<tr>
    <td class="td-padding">
        <label class="Validform_label">
            启封火区、排放瓦斯、突出矿井过构造带及石门揭煤等高危作业实施前，新技术、新材料试验或推广应用前，连续停工停产1个月以上的煤矿复工复产前，开展1次专项辨识： 1.专项辨识由分管负责人组织有关业务科室、生产组织单位（区队）进行； 2.重点辨识作业环境、工程技术、设备设施、现场操作等方面存在的安全风险； 3.补充完善重大安全风险清单并制定相应的管控措施； 4.辨识评估结果作为编制安全技术措施依据
        </label>
    </td>
    <td>
...
<tr>
    <td class="td-padding">
        <label class="Validform_label">
            本矿发生死亡事故或涉险事故、出现重大事故隐患或所在省份发生重特大事故后，开展1次针对性的专项辨识； 1.专项辨识由矿长组织分管负责人和业务科室进行； 2.识别安全风险辨识结果及管控措施是否存在漏洞、盲区； 3.补充完善重大安全风险清单并制定相应的管控措施； 4.辨识评估结果用于指导修订完善设计方案、作业规程、操作规程、安全技术措施等技术文件
        </label>
    </td>
    <td>
