...
<head>
    ...
    <script type="text/javascript">
        ...
        function showTips(data){
            tip(data.msg);
            debugger
            window.top.reload_tBDangerSourceListOnCheck.call();
//            parent.window.reload();
            setTimeout("$('#closeBtn').click()",2*1000);
        }
        function formSubmit(){
...
<body>
<t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="tBDangerSourceController.do?doUpdateDangerSourceOnCheck" tiptype="3" callback="showTips" btnsub="btn_sub">
...
<input id="reportStatus" name="reportStatus" type="hidden" value="${tBDangerSourcePage.reportStatus }"/>
<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
<tr>
    <td align="right">
        <label class="Validform_label">风险点类型:
        </label>
    </td>
    <td class="value">
        <t:dictSelect id="addressCate" field="addressCate"  typeGroupCode="addressCate" extendJson="{'onchange':'fillFXDJFXZ();'}" hasLabel="false" defaultVal="${tBDangerSourcePage.addressCate}"></t:dictSelect>
...
<tr>
    <td colspan="4">
        <div class="ui_buttons" style="text-align: center;">
            ...
            <input type="button" id="btn_save" value="保存" class="ui_state_highlight" onclick="formSubmit()">
