...
<div id="tempSearchColums" style="display: none">
  <div name="searchColumsCenter" >
          ...
          <span style="vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 190px;text-align:right;text-overflow:ellipsis;-o-text-overflow:ellipsis; overflow: hidden;white-space:nowrap;  ">
            <input  name="queryHandleStatus" value="500" type="hidden">
            <label>
...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBMajorHiddenDangerList" checkbox="true" pagination="true" fitColumns="true" title="重大隐患" actionUrl="tBMajorHiddenDangerController.do?datagrid&clStatus=500" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
    ...
    <t:dgToolBar title="复查" icon="icon-edit" url="tBMajorHiddenDangerController.do?goUpdate&load=review" funname="noteUpdate" operationCode="update" ></t:dgToolBar>
 ...
 $(document).ready(function(){
   ...
   $("input[name='queryHandleStatusTem']").change(function() {
     ...
     if (selectedvalue == "true") {
       ...
       $("input[name='queryHandleStatus']").val("600");

     } else {
       //待复查，显示复查按钮
       $("div[class='datagrid-toolbar']>span:first>a[icon='icon-edit']").css("display", "");
       $("input[name='queryHandleStatus']").val("500");
   ...
   if(rows== null || rows.length < 1){
     ...
     $.ajax({
       ...
       success:function(data){
         ...
         console.log(result);
         if("500" == result.msg){
           openwindow("编辑","tBMajorHiddenDangerController.do?goUpdate&load=review&id="+rows[0].id,"tBMajorHiddenDangerList",600,400);
         }else{
