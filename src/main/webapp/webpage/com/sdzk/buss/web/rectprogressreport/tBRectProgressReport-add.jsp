...
<html>
 <head>
  ...
  //编写自定义JS代码
	  $(function(){
		  var reportPersonSelect = getUserMagicSuggest($("#reportPersonSelect"), $("#reportPerson"));
		  var rectUnitSelect = getDepartMagicSuggest($("#rectUnitSelect"), $("#rectUnit"));
		  var rectManSelect = getUserMagicSuggest($("#rectManSelect"), $("#rectMan"));
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBRectProgressReportController.do?doAdd" tiptype="3" callback="@Override noteSubmitCallback" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
							   <input id="reportDate" name="reportDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
					      						 datatype="*" 
					      						ignore="checked"
					      						/>    
				...
				<tr>
					...
					<td class="value">
						<div id="reportPersonSelect" style="height: 15px;width: 130px"></div>
					     	 <input id="reportPerson" name="reportPerson" type="hidden"
									datatype="*"
							 />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<textarea id="reportDesc" name="reportDesc" style="width: 80%;height: auto;" class="inputxt" datatype="*"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	<input id="isComplete" name="isComplete" type="checkbox" value="1"/>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">整改完成并上报</label>
						</td>
				</tr>
