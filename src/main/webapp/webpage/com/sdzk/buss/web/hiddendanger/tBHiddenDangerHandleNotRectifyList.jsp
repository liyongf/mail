...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBHiddenDangerHandleList" onDblClick="dblClickDetail" onLoadSuccess="loadSuccess" autoLoadData="true" checkbox="true" fitColumns="false" title="超期未整改列表" actionUrl="tBHiddenDangerHandleController.do?notRectifyListDatagrid" idField="id" sortName="hiddenDanger.examDate" sortOrder="desc" fit="true" queryMode="group">
