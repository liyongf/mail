...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var acceptUserSelect = getMagicSuggest($('#acceptUserSelect'), $("#acceptUser"), {}, "${tBInvestigatePlanPage.acceptUser}", false,1,"realName");
...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBInvestigatePlanController.do?doAdd" tiptype="3">
