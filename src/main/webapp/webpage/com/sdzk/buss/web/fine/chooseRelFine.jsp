...
<div class="easyui-layout" fit="true">
  ...
  <div region="center" style="" title="">
      <t:datagrid name="tBDangerSourceList" checkbox="true" fitColumns="false" title="罰款列表" actionUrl="tBFineController.do?fineDatagrid&hiddenId=${hiddenId}" idField="id" fit="true" queryMode="group" onLoadSuccess="loadSuccess">
...
<script>
    function addRelFunction (){
        ...
        if((rows.length<=0 && isSelectedAll==false) || (allrows.length<=0 && isSelectedAll==true)){
            ...
            $.ajax({
                url: "tBFineController.do?saveRelChooseFine&ids="+ids+"&hiddenId=${hiddenId}",
                type: 'POST',
                error: function(){
                },
