...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="col-xs-12 col-md-6 col-lg-6" title="违章级别" style="height: 350px;">
            <iframe id="goThreeVioLevelStatistics"
                    src='threeVioAnalyseController.do?goThreeVioLevelStatistics&startDate=${startDate}&endDate=${endDate}' style="height: 100%;width: 100%;"
                    frameborder="0" scrolling="no"></iframe>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-6" title="违章分类" style="height: 350px;">
            <iframe id="goThreeVioTypeStatistics"
                    src='threeVioAnalyseController.do?goThreeVioTypeStatistics&startDate=${startDate}&endDate=${endDate}' style="height: 100%;width: 100%;"
                    frameborder="0" scrolling="no"></iframe>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-6" title="部门违章分布" style="height: 350px;">
            <iframe id="goDepartThreeVioStatistics"
                    src='threeVioAnalyseController.do?goDepartThreeVioStatistics&startDate=${startDate}&endDate=${endDate}' style="height: 100%;width: 100%;"
                    frameborder="0" scrolling="no"></iframe>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-6" title="违章变化趋势" style="height: 350px;">
            <iframe id="goThreeVioTrendStatistics"
                    src='threeVioAnalyseController.do?goThreeVioTrendStatistics&startDate=${startDate}&endDate=${endDate}' style="height: 100%;width: 100%;"
                    frameborder="0" scrolling="no"></iframe>
        </div>
    </div>
</div>
...
<script>
    ...
    function doQuery() {
        ...
        $('#goThreeVioLevelStatistics').attr('src', "threeVioAnalyseController.do?goThreeVioLevelStatistics"+condition);
        $('#goThreeVioTypeStatistics').attr('src', "threeVioAnalyseController.do?goThreeVioTypeStatistics"+condition);
        $('#goDepartThreeVioStatistics').attr('src', "threeVioAnalyseController.do?goDepartThreeVioStatistics"+condition);
        $('#goThreeVioTrendStatistics').attr('src', "threeVioAnalyseController.do?goThreeVioTrendStatistics"+condition);
    }
