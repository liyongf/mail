...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBLayerController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="url" name="url" type="text" style="width: 300px" class="inputxt" datatype="*"   value='${tBLayerPage.url}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<input id="center" name="center" type="text" style="width: 300px" class="inputxt" datatype="*"   value='${tBLayerPage.center}'/>
							<span class="Validform_checktip"></span>
