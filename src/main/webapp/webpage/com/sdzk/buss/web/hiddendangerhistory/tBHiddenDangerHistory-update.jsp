...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBHiddenDangerHistoryController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
									  <input id="dealTime" name="dealTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" datatype="*" 
									  ignore="checked"
									    value='<fmt:formatDate value='${tBHiddenDangerHistoryPage.dealTime}' type="date" pattern="yyyy-MM-dd"/>'>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBHiddenDangerHistoryPage.dealStep}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBHiddenDangerHistoryPage.dealDesc}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBHiddenDangerHistoryPage.dealUserName}'>
							<span class="Validform_checktip"></span>
