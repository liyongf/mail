...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
      <t:datagrid name="tBDangerSourceList" checkbox="true" pagination="true" fitColumns="true" title="关联罚款列表" actionUrl="tBFineController.do?chooseFineDataGrid&busId=${busId}" idField="id" fit="true" queryMode="group">
      ...
      <t:dgToolBar title="删除关联"  icon="icon-remove" url="tBFineController.do?doBatchDelAddressRel&hiddenId=${busId}" funname="doBatchDelAddressRel"></t:dgToolBar>
      </t:datagrid>
  </div>
 </div>
...
<link rel="stylesheet" type="text/css" href="plug-in/lhgDialog/skins/default.css">
 ...
 function choosefine(){
     openwindow('选择罚款','tBFineController.do?goRelFineList&hiddenId=${busId}',"",1000,500);
