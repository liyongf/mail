...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="tBMajorHiddenDangerList" onDblClick="dblClickDetail" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="tBHiddenDangerCheckPlanCountController.do?checkPlanCountListDatagrid&beginMonth=${beginMonth}&endMonth=${endMonth}&type=${type}" idField="id" fit="true" queryMode="group" >
            ...
            <t:dgCol title="风险点类型"  field="riskPointType"  dictionary="investPlan_riskPoint_type"  queryMode="group"  width="120"></t:dgCol>
            ...
            <t:dgCol title="状态"  field="status"  dictionary="investigatePlan_status"  queryMode="group"  width="120"></t:dgCol>
