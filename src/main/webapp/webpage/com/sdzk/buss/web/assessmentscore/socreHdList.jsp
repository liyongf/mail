...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="hdList" checkbox="true" width="900px" height="450px" fitColumns="false" title="隐患" actionUrl="assessmentScoreController.do?hdListDatagrid&yearMonth=${yearMonth}&type=${type}&selectId=${selectId}&selectType=${selectType}" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
            ...
            <t:dgToolBar title="查看" icon="icon-search" url="tBHiddenDangerExamController.do?goUpdate&examType=yh" funname="detail" width="950" height="600" ></t:dgToolBar>
        </t:datagrid>
    </div>
</div>