...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBAlertLevelColorController.do?doAdd">
			...
			<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<%--<input class="inputxt" id="alertLevelName" name="alertLevelName" datatype="*">--%>
						<select name="alertLevelName" id="alertLevelName" width="150" datatype="alertLevel" errormsg="该预警等级已存在，请勿重复添加！">
				...
				<tr>
					...
					<td class="value">
						<input id="alertLevelColor" name="alertLevelColor"  type="text" style="width: 124px;padding-left:26px;" class="inputxt"  datatype="*">
						<span class="Validform_checktip"></span>
