    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <c:if test="${examType ne 'sjjc'}">
            <tr>
                ...
                <td class="value">
                    ...
                    <input type="hidden" name="fillCardManId" id="fillCardManId" value="" style="width: 150px" class="inputxt" datatype="*" >
        ...
        <c:if test="${examType eq 'sjjc'}">
            ...
            <tr>
                ...
                <td class="value">
                    <input id="sjjcDept" name="sjjcDept" type="text" style="width: 150px" class="inputxt" datatype="*" >
                ...
                <td class="value">
                    <input id="sjjcCheckMan" name="sjjcCheckMan" type="text" style="width: 300px" class="inputxt" >
        ...
        <c:if test="${examType eq 'other'}">
            <tr>
                ...
                <td class="value" colspan="3">
                    <input id="checkType" name="checkType" type="text" style="width: 150px" class="inputxt" datatype="*" >
        ...
        <c:if test="${examType eq 'sjjc'}">
            <tr>
                ...
                <td class="value" colspan="3">
                    ...
                    <input id="reviewManId" name="reviewMan.id"  style="width: 150px" type ="hidden" value=""  datatype="*" class="inputxt">
                    <span class="Validform_checktip">请选择复查人</span>
