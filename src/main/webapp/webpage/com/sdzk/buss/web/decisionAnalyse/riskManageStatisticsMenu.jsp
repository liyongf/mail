...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="riskManageStatisticsList" checkbox="true" onDblClick="dbClick" pagination="true" fitColumns="true" title="过程管控结果分析" actionUrl="tBDecisionAnalyseController.do?riskManageStatisticsDatagridMenu&riskId=${riskId}" idField="id" fit="true" queryMode="group" >
            ...
            <t:dgCol title="风险等级"  field="riskLevel"  dictionary="factors_level" queryMode="single" sortable="false" width="120" ></t:dgCol>
            <c:if test="${type eq 'hazardFactortsNum'}">
