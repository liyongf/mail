         ...
         $("#hazardName").Validform({
             datatype: {
                 hazardNameValid: function (gets, obj, curform, regxp) {
                     if ("${tbHazardManagePage.hazardName}" != gets) {
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
                        ...
                        <script>
                            $("#hazardName").val("${tbHazardManagePage.hazardName}");
                        </script>
               ...
               <%-- <tr>
                    ...
                    <td class="value" colspan="3">
                        <c:forEach items="${dangersTypeList}" var="tsType">
                            <label>
                                <input type="checkbox" name="damageType" value="${tsType.typecode}" ${fn:indexOf(tbHazardManagePage.damageType, tsType.typecode)>=0 ? "checked='checked'":""}>${tsType.typename}
                            </label>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        </c:forEach>
                        <span class="Validform_checktip"></span>
