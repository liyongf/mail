...
<head>
    ...
    <script type="text/javascript">
        //编写自定义JS代码
        $(function(){
            <%--var vioUnitsSelect = getDepartMagicSuggestWithValue($("#vioUnitsSelect"), $("#yeResDepart\\.id"),"${tBDangerSourcePage.yeResDepart.id}",false);--%>
        });
...
<tr>
    ...
    <td class="value">
        <input id="yeRecognizeTime" name="yeRecognizeTime" type="text" value='<fmt:formatDate value='${tBDangerSourcePage.yeRecognizeTime}' type="date" pattern="yyyy-MM-dd"/>' style="width: 150px" class="Wdate" onClick="WdatePicker()" datatype="*" />
...
<c:if test="${initParam.les == 'yes'}">
    ...
    <tr>
        <td align="right">
            <label class="Validform_label">
                <font color="red">*</font>人员暴露在危险中的频率:
            </label>
        </td>
        <td class="value">
            ...
            <span class="Validform_checktip"></span>
            <label class="Validform_label" style="display: none;">人员暴露在危险中的频率</label>
        </td>
        <td align="right">
            <label class="Validform_label">
                风险值:
