...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBSpecialEvaluationController.do?doUpdateOnReport">
    ...
    <input type="hidden" id="reportStatus" name="reportStatus" value="${tBSpecialEvaluationPage.reportStatus}" />
