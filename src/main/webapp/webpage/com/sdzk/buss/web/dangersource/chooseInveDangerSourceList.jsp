...
<div class="easyui-layout" fit="true">
  ...
  <div region="center" style="padding:1px;">
      <t:datagrid name="tBDangerSourceList" checkbox="true" fitColumns="false" title="危险源列表" actionUrl="tBDangerSourceController.do?chooseInveDangerSourceDatagrid&riskPointIds=${riskPointIds}&riskPointType=${riskPointType}&ids=${ids}&month=${month}&from=${from}&inveId=${inveId}" idField="id" fit="true" queryMode="group"  onLoadSuccess="loadSuccess">
...
<script src = "webpage/com/sdzk/buss/web/dangersource/js/tBDangerSourceList.js"></script>
 ...
 function gettBDangerSourceListSelectionsNewLine(field) {
     var ids = [];
