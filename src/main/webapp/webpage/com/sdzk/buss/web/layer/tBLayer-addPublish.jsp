...
//			  frameElement.api.close();
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBLayerController.do?doAddPublish" beforeSubmit="uploadToSmServer();">
		...
		<input id="operatorRealname" name="operatorRealname" type="hidden" value="${operatorRealname }"/>
	  	...
	  	<input id="center" name="center" type="hidden" value=""/>
	  	<input id="publishType" name="publishType" type="hidden" value="self"/>
