...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="tBHiddenDangerHandleList" onDblClick="dblClickDetail" onLoadSuccess="loadSuccess" autoLoadData="true" checkbox="false" fitColumns="false" title="未闭环隐患列表" actionUrl="tBSafetyAnalyseController.do?unclosedHiddenDangerDataGrid&startDate=${startDate}&endDate=${endDate}" idField="id" sortName="hiddenDanger.examDate" sortOrder="desc" fit="true" queryMode="group">
