...
//		  getAddressMagicSuggest($("#locationSelect"), $("#location"));
          getUserMagicSuggestWithValue($("#leaderSelect"), $("input[name='leader']"),"${tBSpecialEvaluationPage.leader}",false);
          getAddressMagicSuggestWithValue($("#locationSelect"), $("input[name='location']"),"${tBSpecialEvaluationPage.location}",false);
	  });
  //编写自定义JS代码
  </script>
 </head>
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBSpecialEvaluationController.do?doClone">
				...
				<tr>
					...
					<td class="value">
						<input id="name" name="name" type="text" style="width: 150px" class="inputxt"
							   datatype="*" value="${tBSpecialEvaluationPage.name}"
						/>
				...
				<tr>
					...
					<td class="value" colspan="3">
								<input id="teamMembers" name="teamMembers" style="width: 440px;" datatype="*" type="text"
									   onclick="choose_participant('选择辨识参加人员')" value="${tBSpecialEvaluationPage.participantName}"/>
