...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
    <t:datagrid name="tBHiddenDangerHandleList" autoLoadData="true" checkbox="false" fitColumns="false" title="隐患列表" actionUrl="tBHiddenDangerHandleController.do?queryListDatagrid&tBAddressInfoEntity_id=${addressId}&isHome=true" idField="id" fit="true" queryMode="group">
