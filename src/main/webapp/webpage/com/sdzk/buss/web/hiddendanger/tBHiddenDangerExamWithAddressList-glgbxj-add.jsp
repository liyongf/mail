...
<html>
 <head>
  ...
  $(function() {
      ...
      magicsuggestSelected = getAddressMagicSuggest($('#magicsuggest'), $("#address"));
...
//          magicsuggestDutyUnitSelSelected.clear();//清空责任单位
 ...
 <body>
  <t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" callback="callbackFun" action="tBHiddenDangerExamController.do?doAdd" tiptype="3"  btnsub="btn">
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                     <input id="examDate" name="examDate" type="text" style="width: 150px" datatype="*" class="Wdate" onClick="WdatePicker({minDate:'2017-5-1',maxDate:'%y-%M-%d'})"
