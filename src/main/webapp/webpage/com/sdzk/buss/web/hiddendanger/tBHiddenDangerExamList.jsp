...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBHiddenDangerExamList" onDblClick="dblClickDetail" checkbox="true" fitColumns="false" title="隐患检查" actionUrl="tBHiddenDangerExamController.do?datagrid&examType=${examType}" idField="id" fit="true" queryMode="group" sortName="examDate" sortOrder="desc">
   ...
   <t:dgCol title="日期"  field="examDate"  formatter="yyyy-MM-dd" query="true"  queryMode="group" sortable="false" width="73" align="center"></t:dgCol>
      ...
      <%--<t:dgCol title="班次"  field="shift" hidden="false" typeGroupCode="workShift" hasLabel="false" queryMode="single" sortable="false" width="120"></t:dgCol>--%>
   ...
   <c:if test="${examType ne 'sjjc'}">
      <t:dgCol title="检查人"  field="fillCardManNames"    queryMode="group" sortable="false" width="67" align="center"></t:dgCol>
   </c:if>
      <c:if test="${examType eq 'sjjc'}">
          <t:dgCol title="上级检查部门"  field="sjjcDept"  queryMode="group" sortable="false" width="77" align="center"></t:dgCol>
          <t:dgCol title="检查人"  field="sjjcCheckMan"    queryMode="group" sortable="false" width="67" align="center"></t:dgCol>
      </c:if>
   ...
   <t:dgCol title="责任人"  field="dutyMan"    queryMode="group" sortable="false" width="70" align="center"></t:dgCol>
      ...
      <%--<t:dgCol title="危险源"  field="dangerId.dangerName"    queryMode="group" sortable="false" width="120"></t:dgCol>--%>
      <c:if test="${examType eq 'sjjc'}">
          <t:dgCol title="备注"  field="remark"  queryMode="group" sortable="false" width="160"></t:dgCol>
      </c:if>
      <c:if test="${examType eq 'sjjc'}">
          <t:dgCol title="复查人"  field="reviewMan.realName"  queryMode="group" sortable="false" width="70" align="center"></t:dgCol>
      </c:if>
   ...
   <t:dgCol title="下井时间开始"  field="beginWellDate" hidden="true" formatter="yyyy-MM-dd"   queryMode="group" sortable="false" width="62" align="center"></t:dgCol>
   <t:dgCol title="下井时间结束"  field="endWellDate" hidden="true" formatter="yyyy-MM-dd"   queryMode="group" sortable="false" width="62" align="center"></t:dgCol>
      <c:if test="${examType ne 'yhpc'}">
