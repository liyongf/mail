...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBDangerSourceList" onDblClick="dblClickDetail" checkbox="false" pagination="true" fitColumns="false" title="风险列表" actionUrl="tBDecisionAnalyseController.do?dangerSourceDatagrid&statisticType=${statisticType}&specialid=${specialid}&year=${year}&yearMonth=${yearMonth}&bMajor=${bMajor}&bReport=${bReport}&unitId=${unitId}" idField="id" fit="true" queryMode="group" sortName="isMajor,yeRecognizeTime" sortOrder="desc,desc">
...
function goDetail(){
    ...
    if(rowsData == null || rowsData.length != 1){
        ...
        var url = 'tBDangerSourceController.do?goDetail&load=detail&id='+rowsData[0]["id"];
        createdetailwindow("查看",url,850,450);
    }
}
 function dblClickDetail(rowIndex,rowData){
     var id=rowData.id;
     var url = "tBDangerSourceController.do?goDetail&load=detail&id="+id;
