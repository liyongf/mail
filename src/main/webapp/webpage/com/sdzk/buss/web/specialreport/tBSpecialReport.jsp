...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBSpecialReportController.do?save&taskId=${taskId}" btnsub="btn">
			<input id="id" name="id" type="hidden" value="${tBSpecialReportPage.id }">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable" id="tab">
				<tr>
					...
					<td class="value" colspan="4">
						<textarea id="baseCondition" name="baseCondition" style="width: 350px;" placeholder="请输入专项工作基本情况" class="inputxt" rows="5">${tBSpecialReportPage.baseCondition}</textarea>
					...
					<td class="value" colspan="4">
						<input class="inputxt" id="chargeMan" name="chargeMan" ignore="ignore"  value="${tBSpecialReportPage.chargeMan}" />
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value" colspan="4">
						<textarea id="identifyGroup" name="identifyGroup" style="width: 350px;" placeholder="请输入辨识组织" class="inputxt" rows="5">${tBSpecialReportPage.identifyGroup}</textarea>
						<span class="Validform_checktip"></span>
					</td>
					<td align="right">
						<label class="Validform_label">
					...
					<td class="value" colspan="4">
						<textarea id="identifyMethod" name="identifyMethod" style="width: 350px;" placeholder="请输入辨识评估方法" class="inputxt" rows="5">${tBSpecialReportPage.identifyMethod}</textarea>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value" colspan="8">
						<textarea id="identifyResult" name="identifyResult" style="width: 350px;" placeholder="请输入辨识结论" class="inputxt" rows="5">${tBSpecialReportPage.identifyResult}</textarea>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
