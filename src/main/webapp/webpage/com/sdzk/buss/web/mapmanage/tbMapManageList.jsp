...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="tBMapManageList" checkbox="true" pagination="true" fitColumns="true" title="矿图列表" actionUrl="tbMapManageController.do?datagrid&uploadType=${uploadType}" idField="id" fit="true" queryMode="group" sortName="uploadTime" sortOrder="desc">
            ...
            <t:dgCol title="是否为当前版本"  field="isUsed" replace="是_1,否_0" queryMode="group"  width="120" align="center"></t:dgCol>

            <t:dgToolBar title="矿图上传" icon="icon-add" url="tbMapManageController.do?goUpload" funname="add" operationCode="add"></t:dgToolBar>
