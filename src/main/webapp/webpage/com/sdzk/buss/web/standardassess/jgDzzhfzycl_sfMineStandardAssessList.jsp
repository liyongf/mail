...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="sfMineStandardAssessList" checkbox="true" fitColumns="true" title="地质灾害防治与测量" actionUrl="sfMineStandardAssessController.do?datagrid&mineType=${mineType}&assessType=${assessType}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" onclick="addbytab()" funname="add" operationCode="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" onclick="editbytab()"  funname="update" operationCode="update" ></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="sfMineStandardAssessController.do?doBatchDel" funname="deleteALLSelect" operationCode="batchdelete" ></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" width="1000" height="800" url="sfMineStandardAssessController.do?goUpdate&mineType=${mineType}&assessType=${assessType}" funname="detail" operationCode="detail" ></t:dgToolBar>
 ...
 $(document).ready(function(){
 		//给时间控件加上样式
 			$("#sfMineStandardAssessListtb").find("input[name='ssaMonth']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
