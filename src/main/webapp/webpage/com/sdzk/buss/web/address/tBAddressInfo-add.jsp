...
<html>
 <head>
  ...
  //编写自定义JS代码
  var magicsuggestManageUnitSelected = "";
  ...
  $(function() {
      ...
      magicsuggestManageManSelected = getUserMagicSuggestAllowFreeEntries($('#magicsuggestManageMan'),  $("#manageMan"), "", false);
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBAddressInfoController.do?doAdd" >
		<input id="id" name="id" type="hidden" value="${tBAddressInfoPage.id }"/>
		<input id="isDelete" name="isDelete" type="hidden" value="${tBAddressInfoPage.isDelete }"/>
	  	<input id="pointStr" name="pointStr" type="hidden" value="${tBAddressInfoPage.pointStr}"/>
	  	<input id="belongLayer" name="belongLayer.id" type="hidden" value="${tBAddressInfoPage.belongLayer.id}"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			<%--<tr>
				...
				<td class="value">
					<t:dictSelect field="belongLayer2" type="list"
								  typeGroupCode="layer" defaultVal="${tBAddressInfoPage.belongLayer}" hasLabel="false"  title="煤层" readonly="readonly"></t:dictSelect>
					<span class="Validform_checktip"></span>
					<label class="Validform_label" style="display: none;">煤层</label>
				</td>
			</tr>--%>
			<tr>
				<td align="right">
					<label class="Validform_label">
						<b style="color: red">*</b>经度:
					</label>
				</td>
				<td class="value">
					<input id="lon" name="lon" type="text" style="width: 150px" class="inputxt"
						   datatype="*"
						   value='${tBAddressInfoPage.lon}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="address" name="address" type="text" style="width: 150px" class="inputxt"
						   ...
						   value='${tBAddressInfoPage.address}'>
					<span class="Validform_checktip"></span>
			...
			<%--<tr>
				<td align="right">
					<label class="Validform_label">
						<b style="color: red">*</b>类型:
					</label>
				</td>
				<td class="value">
					<t:dictSelect field="cate" type="list" extendJson="{\"datatype\":\"*\"}"
								  typeGroupCode="locationCate" defaultVal="${tBAddressInfoPage.cate}" hasLabel="false"  title="类型"></t:dictSelect>
					<span class="Validform_checktip"></span>
            ...
            <tr>
				...
				<tr>
					...
					<td class="value">
						...
						<input id="riskType" type="hidden" name="riskType" >
						<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<textarea  id="description" name="description" cols="6" style="width: 80%">${tBAddressInfoPage.description}</textarea>
					<span class="Validform_checktip"></span>
