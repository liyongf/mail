 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
									  <input id="govePlanDate" name="govePlanDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
									    value='<fmt:formatDate value='${tBMajorHiddenDangerPage.govePlanDate}' type="date" pattern="yyyy-MM-dd"/>' />
						</td>
					</tr>
					<tr>
			...
			<tr>
				...
				<td class="value">
					<input id="respAchDate" name="respAchDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
						   value='<fmt:formatDate value='${tBMajorHiddenDangerPage.respAchDate}' type="date" pattern="yyyy-MM-dd"/>' />
				</td>
			</tr>
			<tr>
				<td class="value" colspan="4">
			...
			<tr>
				...
				<td class="value">
					<input id="fundAchDate" name="fundAchDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
						   value='<fmt:formatDate value='${tBMajorHiddenDangerPage.fundAchDate}' type="date" pattern="yyyy-MM-dd"/>' />
				</td>
			</tr>
			<tr>
				<td class="value" colspan="4">
			...
			<tr>
				...
				<td class="value">
					<input id="planAchDate" name="planAchDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
						   value='<fmt:formatDate value='${tBMajorHiddenDangerPage.planAchDate}' type="date" pattern="yyyy-MM-dd"/>' />
				</td>
			</tr>
			<tr>
				<td class="value" colspan="4">
			...
			<tr>
				...
				<td class="value">
					<input id="measureAchDate" name="measureAchDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
						   value='<fmt:formatDate value='${tBMajorHiddenDangerPage.measureAchDate}' type="date" pattern="yyyy-MM-dd"/>' />
				</td>
			</tr>
			<tr>
				<td class="value" colspan="4">
			...
			<tr>
				...
				<td class="value">
					<input id="goalAchDate" name="goalAchDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})"
						   value='<fmt:formatDate value='${tBMajorHiddenDangerPage.goalAchDate}' type="date" pattern="yyyy-MM-dd"/>' />
				</td>
			</tr>
			<tr>
				<td class="value" colspan="4">
