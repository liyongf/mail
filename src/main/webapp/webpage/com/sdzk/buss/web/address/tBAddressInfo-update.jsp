...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBAddressInfoController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<%--<tr>
					...
					<td class="value">
						<t:dictSelect field="belongLayer" type="list"
									  typeGroupCode="layer" defaultVal="${tBAddressInfoPage.belongLayer}" hasLabel="false"  title="煤层"></t:dictSelect>
				...
				<tr>
					...
					<td class="value">
						<input id="address" name="address" type="text" style="width: 150px" class="inputxt"
							   datatype="*" ajaxurl="tBAddressInfoController.do?addressExists&id=${tBAddressInfoPage.id }"
			...
			<tr>
				...
				<td class="value">
					<t:dictSelect field="isshow" type="list" extendJson="{\"datatype\":\"*\"}"
								  typeGroupCode="sf_yn" defaultVal="${tBAddressInfoPage.isshow}" hasLabel="false"  title="是否显示"></t:dictSelect>
					<span class="Validform_checktip"></span>
