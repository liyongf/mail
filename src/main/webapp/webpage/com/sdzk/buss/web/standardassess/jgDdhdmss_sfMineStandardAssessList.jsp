...
<%--<div class="wz-bt" >您当前的位置：考核评分管理->井工煤矿->调度和地面设施</div>--%>
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
  <t:datagrid name="sfMineStandardAssessList" checkbox="true" fitColumns="true" title="调度和地面设施" actionUrl="sfMineStandardAssessController.do?datagrid&mineType=${mineType}&assessType=${assessType}" idField="id" fit="true" queryMode="group">
