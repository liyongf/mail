...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBHealthExamList" onDblClick="dblClickDetail" checkbox="true" fitColumns="true" title="职业健康检查专项档案" actionUrl="tBHealthExamController.do?datagrid" idField="id" fit="true" queryMode="group">
  <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120" align="center"></t:dgCol>
   ...
   <t:dgCol title="更新日期"  field="updateDate" formatter="yyyy-MM-dd" hidden="true"  queryMode="single"  width="120" align="center"></t:dgCol>
    <t:dgCol title="职业健康检查id"  field="tBHealthExamEntity.id"  hidden="true"  queryMode="single"  width="120" align="center"></t:dgCol>
   ...
   <t:dgToolBar title="编辑" operationCode="update" icon="icon-edit" url="tBHealthExamController.do?goUpdate" funname="update" height="700"></t:dgToolBar>
   <t:dgToolBar title="查看" operationCode="detail" icon="icon-search" url="tBHealthExamController.do?goUpdate" funname="detail" height="700"></t:dgToolBar>
 ...
 <script src = "webpage/com/sdzk/buss/web/health/js/tBHealthExamList.js"></script>
 <script type="text/javascript">
     function dblClickDetail(rowIndex,rowData){
         var id=rowData.id;
         var url = "tBHealthExamController.do?goUpdate&load=detail&id="+id;
         createdetailwindow("查看",url,null,700);
     }
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'tBHealthExamController.do?upload', "tBHealthExamList");
}

//导出
function ExportXlsByT() {
	JeecgExcelExport("tBHealthExamController.do?exportXlsByT","tBHealthExamList");
}

//模板下载
function ImportXlsT() {
	JeecgExcelExport("tBHealthExamController.do?importXlsT","tBHealthExamList");
}
 </script>