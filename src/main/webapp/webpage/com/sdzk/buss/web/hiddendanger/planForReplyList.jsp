...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="tBMajorHiddenDangerList" onDblClick="dblClickDetail" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="tBHiddenDangerCheckPlanCountController.do?planForReplyListDatagrid&beginMonth=${beginMonth}&endMonth=${endMonth}&type=${type}" idField="id" fit="true" queryMode="group" >
