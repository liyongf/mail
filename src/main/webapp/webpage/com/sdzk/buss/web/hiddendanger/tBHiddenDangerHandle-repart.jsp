 ...
 <head>
  ...
  //编写自定义JS代码
	  $(function(){
          ...
          var  reviewUnitSelect = $('#reviewUnitSelect').magicSuggest({
          ...
          $(reviewUnitSelect).on('selectionchange', function(c){
              $("#reviewUnit").val(reviewUnitSelect.getValue());
              reviewSelect.setData("magicSelectController.do?getUserList&orgIds="+reviewUnitSelect.getValue());
          });
      ...
      function showLimitDate(ishidden){
          if("1" == ishidden){
              ...
              $("#reviewlb").html("<b style=\"color: red\">*</b>复查情况:");
          }
      }
  </script>
 </head>
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBHiddenDangerHandleController.do?saveRepart" callback="@Override noteSubmitCallback" >
			...
			<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<div id="reviewUnitSelect" style="width: 130px;height: 15px;" class="inputxt"></div>
						<input id="reviewUnit" name="reviewUnit" type="hidden" >
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">复查单位</label>
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr class="pass">
					<td align="right">
						<label class="Validform_label" id="reviewlb">
							复查情况:
						</label>
					</td>
					<td class="value">
						<textarea name="reviewReport" id="reviewReport" class="inputxt" style="width: 280px; height: 100px;" >${tBHiddenDangerHandle.reviewReport}</textarea>
						<span class="Validform_checktip"></span>
