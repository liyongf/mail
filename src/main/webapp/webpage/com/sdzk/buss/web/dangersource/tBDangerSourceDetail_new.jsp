...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBHiddenDangerExamController.do?doUpdate" tiptype="1">
    ...
    <table style="width: 80%;margin:0 auto;position: relative;top: 60px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value">${tBDangerSourcePage.addressCatetemp}</td>
            <td align="right">
                <label class="Validform_label">
        ...
        <tr>
            ...
            <td class="value">${tBDangerSourcePage.hazard.hazardName}</td>
        </tr>
        <tr>
            <td align="right">
                <label class="Validform_label">
        ...
        <c:if test="${initParam.les == 'no'}">
            ...
            <tr>
                ...
                <td class="value">${tBDangerSourcePage.activity.activityName}</td>
            </tr>
        </c:if>
        ...
        <c:if test="${initParam.les == 'yes'}">
            ...
            <tr>
                ...
                <td class="value" colspan="3">${tBDangerSourcePage.activity.activityName}</td>
            </tr>
        </c:if>
        <tr>
            <td align="right">
        ...
        <tr>
            ...
            <td class="value">${tBDangerSourcePage.post.postName}</td>
            <td align="right" style="width: 100px;">
                <label class="Validform_label">
                    <font color="red">*</font>隐患描述:
                </label>
            </td>
            <td class="value">${tBDangerSourcePage.yeMhazardDesc}</td>
        </tr>
        <tr>
            <td align="right">
                <label class="Validform_label">
