...
<div class="easyui-layout" fit="true">
    ...
    <div region="west" style="width: 400px;" title="地点列表" split="true" collapsed="true" >
        <t:datagrid name="tBAddressInfoList" checkbox="false" onDblClick="locationAddress" fitColumns="true" title=""
            ...
            <t:dgToolBar title="查看详情" operationCode="detail" icon="icon-search" url="tBAddressInfoController.do?detailWithRiskHiddenVio_new&type=all" funname="detail" height="600" width="800"></t:dgToolBar>
