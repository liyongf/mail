...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding:1px;">
        <t:datagrid name="tBDangerSourceList" checkbox="true" fitColumns="false" title="风险列表" actionUrl="tBWorkProcessManageController.do?initChooseDangers&workid=${id}"  idField="id" fit="true" queryMode="group"  onLoadSuccess="loadSuccess">
    ...
    api.button(
            {
                ...
                callback: function(){
                    ...
                    if(rows.length <=0){
                        ...
                        ids.join(',');
                        $.ajax({
                            url: "tBWorkProcessManageController.do?saveChooseDanger&ids="+ids+"&tt="+new Date()+"&workId=${id}",
                            type: 'POST',
                            error: function(){
                            },
