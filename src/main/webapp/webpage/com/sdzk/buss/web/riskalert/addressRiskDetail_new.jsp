...
<div>隐患：${countHidden}&nbsp;&nbsp;&nbsp;&nbsp;</div>
<t:tabs id="tt" iframe="false" tabPosition="top" fit="true" width="100%" >
    <%-- <t:tab iframe="riskAlertManageController.do?addressDangerSourceList&addressId=${tBAddressInfoPage.id}" title="风险" heigth="400px" id="a"></t:tab> --%>
    <t:tab iframe="riskAlertManageController.do?addressHiddenDangerList&addressId=${tBAddressInfoPage.id}" title="隐患（${countHidden}）" heigth="450px" id="b"></t:tab>
