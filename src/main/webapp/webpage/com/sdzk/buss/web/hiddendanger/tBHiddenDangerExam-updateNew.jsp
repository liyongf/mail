...
<head>
	...
	<script type="text/javascript">
		...
		$(function() {
            ...
            magicsuggestManageDutyManSelected = getUserMagicSuggestWithValue($('#magicsuggestManageDutyManId'),  $("#manageDutyManId"), "${tBHiddenDangerExamPage.manageDutyManId}", false);
            ...
            magicsuggestManageDutyUnitSelSelected = $('#magicsuggestManageDutyUnitSel').magicSuggest({
                ...
                data:'magicSelectController.do?departSelectDataGridMagic',
                valueField:'id',
                value:["${tBHiddenDangerExamPage.manageDutyUnit.id}"],
                placeholder:'输入或选择',
                maxSelection:1,
                selectFirst: true,
                highlight: false,
    ...
    <tr>
		...
		<tr>
			...
			<td class="value" <c:if test="${xiezhuang ne 'true'}">colspan="3"</c:if>>
				...
				<input type="hidden" name="riskId.id" id="riskId" value="${tBHiddenDangerExamPage.riskId.id}" style="width: 150px" class="inputxt" <c:if test="${xiaogang eq 'true' || ezhuang eq 'true'}">datatype="*"</c:if> >
        ...
        <tr>
			...
			<td class="value">
				...
				<input id="dutyManId" name="dutyManId" type="hidden" style="width: 150px" class="inputxt"  value="${tBHiddenDangerExamPage.dutyManId}">
		...
		<tr>
			...
			<td class="value">
				...
				<input id="manageDutyUnitId" name="manageDutyUnitId" type="hidden" style="width: 150px" class="inputxt" value="${tBHiddenDangerExamPage.manageDutyUnit.id}">
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				...
				<input type="hidden" name="manageDutyManId" id="manageDutyManId" value="" style="width: 150px" class="inputxt"  value="${tBHiddenDangerExamPage.manageDutyManId}">
				<span class="Validform_checktip"></span>
