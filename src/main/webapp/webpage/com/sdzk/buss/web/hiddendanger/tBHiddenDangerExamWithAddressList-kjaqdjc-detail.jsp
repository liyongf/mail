...
<table style="width: 80%;margin:0 auto;position: relative;top:60px;" cellpadding="0" cellspacing="1" class="formtable">
    ...
    <tr>
        ...
        <td class="value">
            ...
            <input type="hidden" name="address.address" id="address.address" value="${tBHiddenDangerExamPage.address.id}">
    ...
    <tr>
        ...
        <td class="value" colspan="3">
            <label>${tBHiddenDangerExamPage.itemUserNameTemp}</label>
        </td>
    </tr>
...
<script>
    <%--$(function(){--%>
        <%--var test = ${tBHiddenDangerExamPage.handleEntity.handlelStatus};--%>
        <%--alert(test);--%>
    <%--});--%>
</script>
<script>
