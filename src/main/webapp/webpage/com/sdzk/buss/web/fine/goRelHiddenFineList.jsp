...
<div class="easyui-layout" fit="true">
  ...
  <div region="center" style="" title="">
      <t:datagrid name="tBDangerSourceList" checkbox="true" fitColumns="false" title="隐患列表" actionUrl="tBFineController.do?fineHiddenDatagrid&hiddenId=${hiddenId}" idField="id" fit="true" queryMode="group" onLoadSuccess="loadSuccess">
...
<script>
    function addRelFunction (){
        ...
        if((rows.length<=0 && isSelectedAll==false) || (allrows.length<=0 && isSelectedAll==true)){
            ...
            $.ajax({
                url: "tBFineController.do?saveRelChooseHiddenFine&ids="+ids+"&hiddenId=${hiddenId}",
                type: 'POST',
                error: function(){
                },
