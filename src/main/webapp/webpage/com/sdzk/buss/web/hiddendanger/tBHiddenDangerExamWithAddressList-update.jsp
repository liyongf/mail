...
<tr>
    ...
    <td class="value">
        ...
        <c:if test="${examType eq 'glgbxj'}">
            <label>
                <input type="checkbox" name="isWithClass" value="1" ${ tBHiddenDangerExamPage.isWithClass eq "1"?"checked":""}>带班
            </label>
        </c:if>
        <span class="Validform_checktip"></span>
...
<tr>
    ...
    <td class="value" colspan="3">
        <input type="text" name="beginWellDate" id="beginWellDate" value='<fmt:formatDate value='${tBHiddenDangerExamPage.beginWellDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>'>--
        <input type="text" name="endWellDate" id="endWellDate" value='<fmt:formatDate value='${tBHiddenDangerExamPage.endWellDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>'>
        <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value" colspan="3">
                <t:dictSelect field="proType" type="list" extendJson="{\"datatype\":\"*\"}"
                              typeGroupCode="proCate_gradeControl" defaultVal="${tBHiddenDangerExamPage.proType}" hasLabel="false"  title="专业类型"></t:dictSelect>
