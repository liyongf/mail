...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBAccidentInductrialinjuryController.do?doAdd" tiptype="3">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="inductrialinjurylevel" name="inductrialinjurylevel" type="text" datatype="*" style="width: 150px" class="inputxt" >
