...
<body>
<t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="tBDangerSourceController.do?doUpdateUniversalDangerSource" tiptype="3" callback="showTips" btnsub="btn_sub">
...
<tr>
    ...
    <tr>
        ...
        <%--</td>--%>
        <%--<td class="value" colspan="3">--%>
                <%--&lt;%&ndash;<label><input id="notMajor" name="isMajor" type="radio" value="0" checked="checked" onclick="setIsMajorNo()"/>否</label>&ndash;%&gt;--%>
