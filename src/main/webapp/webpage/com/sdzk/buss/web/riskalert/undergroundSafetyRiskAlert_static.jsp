...
<div class="easyui-layout" fit="true">
    ...
    <div region="west" style="width: 420px;" title="地点列表" split="true" collapsed="true" >
        <t:datagrid name="tBAddressInfoList" checkbox="false" onDblClick="locationAddress" fitColumns="true" title=""
            ...
            <t:dgCol title="静态风险等级" field="staticRiskLevel" formatterjs="staticColorValueFormatter" query="false" queryMode="single" width="100"
           ...
           <%-- <t:dgCol title="动态风险等级" field="riskLevel" formatterjs="colorValueFormatter" query="false" queryMode="single" width="100"
            ...
            <t:dgToolBar title="查看详情" operationCode="detail" icon="icon-search" url="tBAddressInfoController.do?detailWithRiskHiddenVio_new&type=static" funname="detail" height="600" width="800"></t:dgToolBar>
...
<script type="text/javascript">
    ...
    function ExportXls() {
        JeecgExcelExport("riskAlertManageController.do?exportXls", "tBAddressInfoList");
    }
</script>
