...
<script type="text/html" id="qualitycontrolmoduleEditDialog">
    <form id="qualitycontrolmoduleEditForm" lay-filter="qualitycontrolmoduleEditForm" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="margin-right: 50px">
                <input name="score" placeholder="分数" class="layui-input" lay-verType="tips" lay-verify="number" value="100" autocomplete="off" />
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="margin-right: 50px">
                <input name="sort" placeholder="排序" class="layui-input" lay-verType="tips" lay-verify="number" autocomplete="off" />
            </div>
        </div>
...
<script type="text/html" id="qualitycontrolmoduleEditTree1DialogLeft">
    <form id="qualitycontrolmoduleEditTree1FormLeft" lay-filter="qualitycontrolmoduleEditTree1FormLeft" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">分数:</label>
            <div class="layui-input-block" style="margin-right: 50px">
                <input id="scoreModule" name="score" placeholder="分数" class="layui-input"   value="" autocomplete="off" />
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">权重:</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">排序:</label>
            <div class="layui-input-block" style="margin-right: 50px">
                <input id="sortModule" name="sort" placeholder="排序" class="layui-input" lay-verType="tips" lay-verify="number" autocomplete="off" />
            </div>
        </div>
        <div class="layui-form-item text-right" style="width: 160px;float: right">
...
<script type="text/html" id="qualitycontrolmoduleEditTreeDialog">
    <form id="qualitycontrolmoduleEditTreeForm" lay-filter="qualitycontrolmoduleEditTreeForm" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="margin-right: 50px">
                <input name="totalScore" placeholder="总分数" class="layui-input" lay-verType="tips"  lay-verify="number" autocomplete="off" />
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">排序:</label>
...
<script type="text/html" id="qualitycontrolmoduleEditTree1Dialog">
    <form id="qualitycontrolmoduleEditTree1Form" lay-filter="qualitycontrolmoduleEditTree1Form" class="layui-form model-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">排序:</label>
            <div class="layui-input-block" style="margin-right: 50px">
                <input id="sort2" name="sort" placeholder="排序" class="layui-input" lay-verType="tips"  lay-verify="number" autocomplete="off" />
            </div>
        </div>
        <div class="layui-form-item text-right" style="width: 160px;float: right">
            <button class="layui-btn" lay-filter="qualitycontrolmoduleEditTree1Submit" lay-submit>保存</button>
            ...
            <tr>
                <td>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" style="margin-right: 50px">
                            <input name="standardScore" placeholder="标准分值" class="layui-input" lay-verType="tips" lay-verify="number" autocomplete="off" />
                        </div>
                    </div>
                </td>
                <td>
                    <div class="layui-form-item">
                        <label class="layui-form-label layui-form-required">排序:</label>
                        <div class="layui-input-block" style="margin-right: 50px">
                            <input name="a2" placeholder="排序" class="layui-input" lay-verType="tips"  lay-verify="number" autocomplete="off" />
                        </div>
                    </div>
                </td>
            </tr>
...
<!-- 基本要求表单弹窗 -->
<script type="text/html" id="qualitycontrolrequirementsHeBingEditDialog">
    <div id="qualitycontrolrequirementsHeBingEditForm" lay-filter="qualitycontrolrequirementsHeBingEditForm"
        ...
        <table>
            <tr>
                <td>
                    <div class="layui-form-item">
                        <label class="layui-form-label layui-form-required" style="width: 120px;">合并分数标识说明:</label>
                        <div class="layui-input-block" style="margin-right: 20px; margin-left: 150px">
                            1、需要合并的考核内容的合并分数标识需要一样<br>
                            2、合并分数标识不同合并块要保持唯一
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="layui-form-item">
                        <label class="layui-form-label layui-form-required" style="width: 120px;">合并分数标识:</label>
                        <div class="layui-input-block" style="margin-right: 20px; margin-left: 150px">
                            <input id="a5" name="a5" placeholder="请输入" class="layui-input" lay-verType="tips"
            ...
            <tr>
                <td>
                    <div class="layui-form-item text-right" style="margin-right: 20px">
                        <button class="layui-btn" lay-filter="qualitycontrolrequirementsHeBingEditSubmit"
...
<script type="text/javascript">
    layui.use(["layer","form","table", "util", "tree", "layedit", 'admin', 'formX'], function() {
        ...
        function renderTreeLeft() {
            admin.req(baseServer+'qualityControlModule/findByPage.do', {}, function(res) {
                console.log(res)
        ...
        function renderTree(data) {
            admin.req(baseServer+'qualityControlProject/findByPage.do', {
                moduleId: data
            }, function(res) {
                var data = res.datas.list;
                for (var i = 0; i < data.length; i++) {
                ...
                tree.render({
                    ...
                    click: function(obj) {
                        ...
                        insTb1 = table.render({
                            ...
                            url: baseServer +
                                'qualityControlRequirements/findByPage.do',
                            where: {
                                a1: obj.data.id,
                            },
                            method: 'POST',
                            ...
                            toolbar: ['<p>',
                                ...
                                '<button lay-event="hebingfenshu" class="layui-btn layui-btn-sm icon-btn">合并分数</button>&nbsp;',
                                '<button lay-event="qxhebingfenshu" class="layui-btn layui-btn-sm icon-btn">取消合并分数</button>&nbsp;',
                                '</p>'
                            ].join(''),
                            defaultToolbar: [],
                            cellMinWidth: 100,
        ...
        table.on('toolbar(qualitycontrolrequirementsTable)', function(obj) {
            ...
            } else if (obj.event === 'hebingfenshu') { //合并分数
                var checkRows = table.checkStatus('qualitycontrolrequirementsTable');
                if (checkRows.data.length === 0) {
                    layer.msg('请选择要合并分数的数据', {
                        icon: 2
                    });
                    return;
                }
            ...
            } else if (obj.event === 'qxhebingfenshu') { //取消合并分数
                var checkRows = table.checkStatus('qualitycontrolrequirementsTable');
                if (checkRows.data.length === 0) {
                    layer.msg('请选择要取消合并分数的数据', {
                        icon: 2
                    });
                    return;
                }
            ...
            admin.open({
                ...
                success: function(layero, dIndex) {
                    ...
                    form.on('submit(qualitycontrolmoduleEditSubmit)', function(data) {
                        ...
                        var url;
                        if (mData) {
                            url = baseServer+"qualityControlModule/update.do";
                        } else {
                            url = baseServer+"qualityControlModule/insert.do";
                        ...
                        }, mData ? 'POST' : 'POST'); // 实际项目可以是mData?'post':'post'
                        return false;
                    });
                }
            });
        ...
        function doDel(obj) {
            layer.confirm('确定要删除选中数据吗？', {
                ...
                layer.close(i);
                var loadIndex = layer.load(2);
                admin.req(baseServer+'qualityControlModule/deleteById.do', {
            ...
            admin.open({
                ...
                success: function(layero, dIndex) {
                    ...
                    form.on('submit(qualitycontrolmoduleEditTreeSubmit)', function(data) {
                        ...
                        var url;
                        if (mData) {
                            url = "qualityControlProject/update.do";
                        } else {
                            url = "qualityControlProject/insert.do";
                        }
                        data.field.parentId = 0;
                        data.field.type = 1;
            ...
            admin.open({
                ...
                success: function(layero, dIndex) {
                    ...
                    form.on('submit(qualitycontrolmoduleEditTree1Form)', function(data) {
                        ...
                        var url;
                        if (mData) {
                            url = baseServer+"qualityControlProject/update.do";
                            data.field.id = selObj2.data.id;
                            data.field.status = $('#statusCenter').val();
                        } else {
                            url = baseServer+"qualityControlProject/insert.do";
                            data.field.type = 2;
        ...
        function doDelId(obj) {
            layer.confirm('确定要删除选中数据吗？', {
                ...
                layer.close(i);
                var loadIndex = layer.load(2);
                admin.req(baseServer+'qualityControlProject/deleteById.do', {
                    id: obj.data ? obj.data.id : '',
                }, function(res) {
                    layer.close(loadIndex);
                    if (200 == res.code) {
            ...
            admin.open({
                ...
                success: function(layero, dIndex) {
                    ...
                    form.on('submit(qualitycontrolrequirementsEditSubmit)', function(data) {
                        ...
                        var url;
                        if (mData) {
                            url = baseServer+"qualityControlRequirements/update.do";
                        } else {
                            url = baseServer+"qualityControlRequirements/insert.do";
                            data.field.a3 = 1;
                        }
        ...
        function yesScoreData(obj) {
            layer.confirm('确定要考核选中数据吗？', {
                ...
                layer.close(i);
                var loadIndex = layer.load(2);
                admin.req(baseServer+'qualityControlRequirements/updateByIds.do', {
        ...
        function hebingScore(obj) {
            layer.confirm('确定该数据是附加项吗？', {
                ...
                layer.close(i);
                var loadIndex = layer.load(2);
                admin.req(baseServer+'qualityControlRequirements/updateA4ByIds.do', {
                    ids: obj.ids ? obj.ids.join(',') : '',
                    a4: '1',
                }, function(res) {
                    layer.close(loadIndex);
        ...
        /*合并分数*/
        function hebingFenShuScore(obj) {
            admin.open({
                type: 1,
                area: '500px',
                title: '添加标识',
                content: $('#qualitycontrolrequirementsHeBingEditDialog').html(),
                success: function (layero, dIndex) {
                    form.on('submit(qualitycontrolrequirementsHeBingEditSubmit)', function (data) {
                        var loadIndex = layer.load(2);
                        admin.req(baseServer+'qualityControlRequirements/updateA5ByIds.do', {
                            ids: obj.ids ? obj.ids.join(',') : '',
                            a5: $('#a5').val(),
                        }, function (res) {
                            layer.close(loadIndex);
        ...
        /*取消合并分数*/
        function qxHebingFenShuScore(obj) {
            layer.confirm('确定要取消合并分数吗？', {
                skin: 'layui-layer-admin',
                shade: .1
            }, function (i) {
                layer.close(i);
        ...
        function doDelName(obj) {
            layer.confirm('确定要删除选中数据吗？', {
                ...
                layer.close(i);
                var loadIndex = layer.load(2);
                admin.req(baseServer+'qualityControlRequirements/deleteById.do', {
                    id: obj.data ? obj.data.id : '',
                    ids: obj.ids ? obj.ids.join(',') : ''
                }, function(res) {
                    layer.close(loadIndex);
