...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="" title="">
        <t:datagrid name="tBDangerSourceList" checkbox="true" fitColumns="false" title="风险列表" actionUrl="tBDangerSourceController.do?postDangerSourceDatagrid&postid=${postid}" idField="id" fit="true" queryMode="group" onLoadSuccess="loadSuccess">
            ...
            <t:dgToolBar title="导出" icon="icon-putout" url="tBDangerSourceController.do?postRelDangerExportXls&postId=${postid}" funname="ExportXls" width="850" height="450"></t:dgToolBar>
        </t:datagrid>
    </div>
</div>
...
<script type="text/javascript">
    //导出
    function ExportXls() {
        JeecgExcelExport("tBDangerSourceController.do?postRelDangerExportXls&postId=${postid}","tBDangerSourceList");
    }
...
<script>
    ...
    function searchReset() {
        ...
        $('#tBDangerSourceList').datagrid({
            url: 'tBDangerSourceController.do?postDangerSourceDatagrid&postid=${postid}&field=id,id_begin,id_end,yeRecognizeYear,hazard.hazardName,yeProfession,yeHazardCate,yeRiskGrade,yeAccidentTemp,yeAccidentTemp_begin,yeAccidentTemp_end,activity.id,riskValue,riskValue_begin,riskValue_end,yeMhazardDesc,yePossiblyHazard,docSource,yeStandard,',
            pageNumber: 1
        });
    }
</script>
