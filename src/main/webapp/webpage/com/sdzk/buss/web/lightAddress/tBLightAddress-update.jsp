...
<title>灯和风险点对应信息</title>
  ...
  $(function(){
	  var addressSelect = getAddressMagicSuggestWithValue($('#addressSelect'), $("#addressId"),"${tBLightAddressPage.addressId}",magicDisable);
  })
  </script>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value">
					<input id="lightId" name="lightId" type="text" style="width: 150px" datatype="*1-100" value="${tBLightAddressPage.lightId}" disabled/>
