...
<tr>
						...
						<td class="value">
                            <label class="Validform_label">${tBEmployeeResumePage.fileNo}</label>
						...
						<td class="value">
                            <label class="Validform_label">${tBEmployeeResumePage.postNumber}</label>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td class="value">
                            ...
                            <label class="Validform_label">${tBEmployeeResumePage.retireNumber}</label>
						</td>
						<td align="right">
							<label class="Validform_label">
								姓名:
						...
						<td class="value">
                            <label class="Validform_label">${tBEmployeeResumePage.name}</label>
