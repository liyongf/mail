...
<body>
<t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="tBDangerSourceController.do?doUpdateDepartDangerSource" tiptype="3" callback="showTips" btnsub="btn_sub">
...
<tr>
    ...
    <td class="value">
        <input id="yeRecognizeTime" name="yeRecognizeTime" type="text" value='<fmt:formatDate value='${tBDangerSourcePage.yeRecognizeTime}' type="date" pattern="yyyy-MM-dd"/>' style="width: 150px" class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d'})" datatype="*" />
...
<tr>
    ...
    <tr>
        ...
        <td class="value">
            <label><input id="notMajor" name="isMajor" type="radio" value="0" <c:if test="${tBDangerSourcePage.isMajor ne '1'}">checked="checked"</c:if> disabled/>否</label>
            <label><input id="isMajor" name="isMajor" type="radio" value="1"
                          <c:if test="${tBDangerSourcePage.isMajor eq '1'}">checked="checked"</c:if> onclick="setIsMajorYes()"/>是</label>
        </td>
        <%--<td align="right">--%>
            <%--<label class="Validform_label">--%>
                <%--是否重大风险:--%>
        ...
        <%--</td>--%>
        <%--<td class="value">--%>
            <%--<label><input name="isMajor" type="radio" value="0" <c:if test="${tBDangerSourcePage.isMajor ne '1'}">checked="checked"</c:if>/>否</label>--%>
            <%--<label><input name="isMajor" type="radio" value="1" <c:if test="${tBDangerSourcePage.isMajor eq '1'}">checked="checked"</c:if>/>是</label>--%>
        <%--</td>--%>
        <td align="right">
            <label class="Validform_label">
...
<tr>
    ...
    <%--</td>--%>
    <%--<td class="value">--%>
        <%--<t:dictSelect id="yeRiskGrade" field="yeRiskGrade" typeGroupCode="riskLevel"  hasLabel="false" defaultVal="${tBDangerSourcePage.yeRiskGrade}"></t:dictSelect>--%>
        <%--<span class="Validform_checktip"></span>--%>
    ...
    <%--</td>--%>
        ...
        <td class="value">
            <input id="yeRiskGrade" name="yeRiskGrade" readonly="true" type="text" style="width: 150px" class="inputxt" value="${tBDangerSourcePage.yeRiskGrade}">
            <span class="Validform_checktip"></span>
            <label class="Validform_label" style="display: none;">风险等级</label>
        </td>
    <td align="right">
    ...
    <td class="value">
        <input id="yeResDepart" name="yeResDepart" type="text" style="width: 150px" value="${tBDangerSourcePage.yeResDepart}" class="inputxt" datatype="*"/>
        <span class="Validform_checktip"></span>
    ...
    <td class="value">
        <input id="yeDistance" name="yeDistance" type="text" style="width: 150px" class="inputxt" value="${tBDangerSourcePage.yeDistance}" ignore="ignore"/>
        <span class="Validform_checktip"></span>
...
<tr>
    ...
    <td class="value">
        ...
        <span class="Validform_checktip"></span>
        <label class="Validform_label" style="display: none;">可能性</label>
    </td>
    <td align="right">
        <label class="Validform_label">
            <font color="red">*</font>损失:
        </label>
    </td>
    <td class="value">
        ...
        <span class="Validform_checktip"></span>
        <label class="Validform_label" style="display: none;">损失</label>
    </td>
    </tr>
<tr>
    <td align="right">
...
<c:if test="${initParam.les == 'yes'}">
    ...
    <tr>
        <td align="right">
            <label class="Validform_label">
                <font color="red">*</font>人员暴露在风险中的概率:
            </label>
        </td>
        <td class="value">
            ...
            <span class="Validform_checktip"></span>
            <label class="Validform_label" style="display: none;">人员暴露在风险中的概率</label>
        </td>
        <td align="right">
            <label class="Validform_label">
...
<%--<tr>--%>
    ...
    <%--</td>--%>
    <%--<td class="value">--%>
        <%--<input id="yeCaseNum" name="yeCaseNum" type="text" style="width: 150px" class="inputxt" value="${tBDangerSourcePage.yeCaseNum}" ignore="ignore"/>--%>
        <%--<span class="Validform_checktip"></span>--%>
...
<tr>
    ...
    <td class="value">
        <textarea id="yeLocation" name="yeLocation" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.yeLocation}</textarea>
        <span class="Validform_checktip"></span>
    ...
    <td class="value">
        ...
        <td class="value">
            <textarea id="yePossiblyHazard" name="yePossiblyHazard" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.yePossiblyHazard}</textarea>
            <span class="Validform_checktip"></span>
...
<tr>
    ...
    <td class="value">
        <textarea id="yeReference" name="yeReference" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.yeReference}</textarea>
        <span class="Validform_checktip"></span>
    ...
    <td class="value">
        <textarea id="yeSurrounding" name="yeSurrounding" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.yeSurrounding}</textarea>
        <span class="Validform_checktip"></span>
...
<tr>
    ...
    <td class="value">
        <textarea id="manageMeasure" name="manageMeasure" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.manageMeasure}</textarea>
        <span class="Validform_checktip"></span>
    ...
    <td class="value">
        <textarea id="yeMonitor" name="yeMonitor" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.yeMonitor}</textarea>
        <span class="Validform_checktip"></span>
...
<tr>
    ...
    <td class="value">
        <textarea id="yeEmergency" name="yeEmergency" class="inputxt" rows="3" style="width: 95%;height:auto;" datatype="*" >${tBDangerSourcePage.yeEmergency}</textarea>
        <span class="Validform_checktip"></span>
